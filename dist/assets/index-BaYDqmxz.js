...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wi,depthTest:!1,depthWrite:!1})}function kb(t,e,n){const i=new Float32Array(Kr),r=new N(0,1,0);return new Li({name:"SphericalGaussianBlur",defines:{n:Kr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:cc(),fragmentShader:`
		...
		`,blending:Wi,depthTest:!1,depthWrite:!1})}function v_(){return new Li({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:cc(),fragmentShader:`
		...
		`,blending:Wi,depthTest:!1,depthWrite:!1})}function x_(){return new Li({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:cc(),fragmentShader:`
	...
	`}class jx extends bi{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new Ux(r),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new Go(5,5,5),s=new Li({name:"CubemapFromEquirect",uniforms:Ma(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:Rn,blending:Wi});s.uniforms.tEquirect.value=n;const a=new Pi(r,s),o=n.minFilter;return n.minFilter===es&&(n.minFilter=hn),new H1(1,10,this).update(e,a),n.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,n=!0,i=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(n,i,r);e.setRenderTarget(s)}}function Bb(t){let e=new WeakMap,n=new WeakMap,i=null;function r(c,p=!1){return c==null?null:p?a(c):s(c)}function s(c){if(c&&c.isTexture){const p=c.mapping;if(p===Gc||p===Wc)if(e.has(c)){const m=e.get(c).texture;return o(m,c.mapping)}else{const m=c.image;if(m&&m.height>0){const M=new jx(m.height);return M.fromEquirectangularTexture(t,c),e.set(c,M),c.addEventListener("dispose",u),o(M.texture,c.mapping)}else return null}}return c}function a(c){if(c&&c.isTexture){const p=c.mapping,m=p===Gc||p===Wc,M=p===cs||p===xa;if(m||M){let g=n.get(c);const d=g!==void 0?g.texture.pmremVersion:0;if(c.isRenderTargetTexture&&c.pmremVersion!==d)return i===null&&(i=new g_(t)),g=m?i.fromEquirectangular(c,g):i.fromCubemap(c,g),g.texture.pmremVersion=c.pmremVersion,n.set(c,g),g.texture;if(g!==void 0)return g.texture;{const x=c.image;return m&&x&&x.height>0||M&&x&&l(x)?(i===null&&(i=new g_(t)),g=m?i.fromEquirectangular(c):i.fromCubemap(c),g.texture.pmremVersion=c.pmremVersion,n.set(c,g),c.addEventListener("dispose",f),g.texture):null}}}return c}function o(c,p){return p===Gc?c.mapping=cs:p===Wc&&(c.mapping=xa),c}function l(c){let p=0;const m=6;for(let M=0;M<m;M++)c[M]!==void 0&&p++;return p===m}function u(c){const p=c.target;p.removeEventListener("dispose",u);const m=e.get(p);m!==void 0&&(e.delete(p),m.dispose())}function f(c){const p=c.target;p.removeEventListener("dispose",f);const m=n.get(p);m!==void 0&&(n.delete(p),m.dispose())}function h(){e=new WeakMap,n=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:h}}function zb(t){const e={};function n(i){if(e[i]!==void 0)return e[i];const r=t.getExtension(i);return e[i]=r,r}return{has:function(i){return n(i)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(i){const r=n(i);return r===null&&ra("WebGLRenderer: "+i+" extension not supported."),r}}}function Vb(t,e,n,i){const r={},s=new WeakMap;function a(h){const c=h.target;c.index!==null&&e.remove(c.index);for(const m in c.attributes)e.remove(c.attributes[m]);c.removeEventListener("dispose",a),delete r[c.id];const p=s.get(c);p&&(e.remove(p),s.delete(c)),i.releaseStatesOfGeometry(c),c.isInstancedBufferGeometry===!0&&delete c._maxInstanceCount,n.memory.geometries--}function o(h,c){return r[c.id]===!0||(c.addEventListener("dispose",a),r[c.id]=!0,n.memory.geometries++),c}function l(h){const c=h.attributes;for(const p in c)e.update(c[p],t.ARRAY_BUFFER)}function u(h){const c=[],p=h.index,m=h.attributes.position;let M=0;if(m===void 0)return;if(p!==null){const x=p.array;M=p.version;for(let S=0,y=x.length;S<y;S+=3){const T=x[S+0],w=x[S+1],b=x[S+2];c.push(T,w,w,b,b,T)}}else{const x=m.array;M=m.version;for(let S=0,y=x.length/3-1;S<y;S+=3){const T=S+0,w=S+1,b=S+2;c.push(T,w,w,b,b,T)}}const g=new(m.count>=65535?Nx:Lx)(c,1);g.version=M;const d=s.get(h);d&&e.remove(d),s.set(h,g)}function f(h){const c=s.get(h);if(c){const p=h.index;p!==null&&c.version<p.version&&u(h)}else u(h);return s.get(h)}return{get:o,update:l,getWireframeAttribute:f}}function Hb(t,e,n){let i;function r(h){i=h}let s,a;function o(h){s=h.type,a=h.bytesPerElement}function l(h,c){t.drawElements(i,c,s,h*a),n.update(c,i,1)}function u(h,c,p){p!==0&&(t.drawElementsInstanced(i,c,s,h*a,p),n.update(c,i,p))}function f(h,c,p){if(p===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,c,0,s,h,0,p);let M=0;for(let g=0;g<p;g++)M+=c[g];n.update(M,i,1)}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=u,this.renderMultiDraw=f}function Gb(t){const e={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(n.calls++,a){case t.TRIANGLES:n.triangles+=o*(s/3);break;case t.LINES:n.lines+=o*(s/2);break;case t.LINE_STRIP:n.lines+=o*(s-1);break;case t.LINE_LOOP:n.lines+=o*s;break;case t.POINTS:n.points+=o*s;break;default:ct("WebGLInfo: Unknown draw mode:",a);break}}function r(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:e,render:n,programs:null,autoReset:!0,reset:r,update:i}}function Wb(t,e,n){const i=new WeakMap,r=new Nt;function s(a,o,l){const u=a.morphTargetInfluences,f=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=f!==void 0?f.length:0;let c=i.get(o);if(c===void 0||c.count!==h){let R=function(){v.dispose(),i.delete(o),o.removeEventListener("dispose",R)};var p=R;c!==void 0&&c.texture.dispose();const m=o.morphAttributes.position!==void 0,M=o.morphAttributes.normal!==void 0,g=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],x=o.morphAttributes.normal||[],S=o.morphAttributes.color||[];let y=0;m===!0&&(y=1),M===!0&&(y=2),g===!0&&(y=3);let T=o.attributes.position.count*y,w=1;T>e.maxTextureSize&&(w=Math.ceil(T/e.maxTextureSize),T=e.maxTextureSize);const b=new Float32Array(T*w*4*h),v=new Cx(b,T,w,h);v.type=Si,v.needsUpdate=!0;const C=y*4;for(let P=0;P<h;P++){const k=d[P],$=x[P],Q=S[P],F=T*w*4*P;for(let Z=0;Z<k.count;Z++){const B=Z*C;m===!0&&(r.fromBufferAttribute(k,Z),b[F+B+0]=r.x,b[F+B+1]=r.y,b[F+B+2]=r.z,b[F+B+3]=0),M===!0&&(r.fromBufferAttribute($,Z),b[F+B+4]=r.x,b[F+B+5]=r.y,b[F+B+6]=r.z,b[F+B+7]=0),g===!0&&(r.fromBufferAttribute(Q,Z),b[F+B+8]=r.x,b[F+B+9]=r.y,b[F+B+10]=r.z,b[F+B+11]=Q.itemSize===4?r.w:1)}}c={count:h,texture:v,size:new ce(T,w)},i.set(o,c),o.addEventListener("dispose",R)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(t,"morphTexture",a.morphTexture,n);else{let m=0;for(let g=0;g<u.length;g++)m+=u[g];const M=o.morphTargetsRelative?1:1-m;l.getUniforms().setValue(t,"morphTargetBaseInfluence",M),l.getUniforms().setValue(t,"morphTargetInfluences",u)}l.getUniforms().setValue(t,"morphTargetsTexture",c.texture,n),l.getUniforms().setValue(t,"morphTargetsTextureSize",c.size)}return{update:s}}function Xb(t,e,n,i,r){let s=new WeakMap;function a(u){const f=r.render.frame,h=u.geometry,c=e.get(u,h);if(s.get(c)!==f&&(e.update(c),s.set(c,f)),u.isInstancedMesh&&(u.hasEventListener("dispose",l)===!1&&u.addEventListener("dispose",l),s.get(u)!==f&&(n.update(u.instanceMatrix,t.ARRAY_BUFFER),u.instanceColor!==null&&n.update(u.instanceColor,t.ARRAY_BUFFER),s.set(u,f))),u.isSkinnedMesh){const p=u.skeleton;s.get(p)!==f&&(p.update(),s.set(p,f))}return c}function o(){s=new WeakMap}function l(u){const f=u.target;f.removeEventListener("dispose",l),i.releaseStatesOfObject(f),n.remove(f.instanceMatrix),f.instanceColor!==null&&n.remove(f.instanceColor)}return{update:a,dispose:o}}const Yb={[dx]:"LINEAR_TONE_MAPPING",[hx]:"REINHARD_TONE_MAPPING",[px]:"CINEON_TONE_MAPPING",[mx]:"ACES_FILMIC_TONE_MAPPING",[_x]:"AGX_TONE_MAPPING",[vx]:"NEUTRAL_TONE_MAPPING",[gx]:"CUSTOM_TONE_MAPPING"};function Zb(t,e,n,i,r,s){const a=new bi(e,n,{type:t,depthBuffer:r,stencilBuffer:s,samples:i?4:0,depthTexture:r?new ya(e,n):void 0}),o=new bi(e,n,{type:ji,depthBuffer:!1,stencilBuffer:!1}),l=new Vn;l.setAttribute("position",new pn([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new pn([0,2,0,0,2,0],2));const u=new U1({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)}const GC={[dx]:"Linear",[hx]:"Reinhard",[px]:"Cineon",[mx]:"ACESFilmic",[_x]:"AgX",[vx]:"Neutral",[gx]:"Custom"};function WC(t,e){const n=GC[e];return n===void 0?(Ve("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+t+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const zl=new N;function XC(){ut.getLuminanceCoefficients(zl);const t=zl.x.toFixed(4),e=zl.y.toFixed(4),n=zl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const eR={[tu]:"SHADOWMAP_TYPE_PCF",[Ka]:"SHADOWMAP_TYPE_VSM"};function tR(t){return eR[t.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const nR={[cs]:"ENVMAP_TYPE_CUBE",[xa]:"ENVMAP_TYPE_CUBE",[oc]:"ENVMAP_TYPE_CUBE_UV"};function iR(t){return t.envMap===!1?"ENVMAP_TYPE_CUBE":nR[t.envMapMode]||"ENVMAP_TYPE_CUBE"}const rR={[xa]:"ENVMAP_MODE_REFRACTION"};function sR(t){return t.envMap===!1?"ENVMAP_MODE_REFLECTION":rR[t.envMapMode]||"ENVMAP_MODE_REFLECTION"}const aR={[fx]:"ENVMAP_BLENDING_MULTIPLY",[uT]:"ENVMAP_BLENDING_MIX",[cT]:"ENVMAP_BLENDING_ADD"};function oR(t){return t.envMap===!1?"ENVMAP_BLENDING_NONE":aR[t.combine]||"ENVMAP_BLENDING_NONE"}function lR(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:i,maxMip:n}}function uR(t,e,n,i){const r=t.getContext(),s=n.defines;let a=n.vertexShader,o=n.fragmentShader;const l=tR(n),u=iR(n),f=sR(n),h=oR(n),c=lR(n),p=YC(n),m=ZC(s),M=r.createProgram();let g,d,x=n.glslVersion?"#version "+n.glslVersion+`
...
`)+`
`+d);const S=x+g+a,y=x+d+o,T=A_(r,r.VERTEX_SHADER,S),w=A_(r,r.FRAGMENT_SHADER,y);r.attachShader(M,T),r.attachShader(M,w),n.index0AttributeName!==void 0?r.bindAttribLocation(M,0,n.index0AttributeName):n.hasPositionAttribute===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function b(P){if(t.debug.checkShaderErrors){const k=r.getProgramInfoLog(M)||"",$=r.getShaderInfoLog(T)||"",Q=r.getShaderInfoLog(w)||"",F=k.trim(),Z=$.trim(),B=Q.trim();let U=!0,W=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(U=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,M,T,w);else{const j=C_(r,T,"vertex"),ne=C_(r,w,"fragment");ct("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
}`,AR=[new N(1,0,0),new N(-1,0,0),new N(0,1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1)],bR=[new N(0,-1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1),new N(0,-1,0),new N(0,-1,0)],O_=new Pt,Wa=new N,bf=new N;function CR(t,e,n){let i=new Lp;const r=new ce,s=new ce,a=new Nt,o=new F1,l=new k1,u={},f=n.maxTextureSize,h={[Ur]:Rn,[Rn]:Ur,[yi]:yi},c=new Li({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ce},radius:{value:4}},vertexShader:TR,fragmentShader:wR}),p=c.clone();p.defines.HORIZONTAL_PASS=1;const m=new Vn;m.setAttribute("position",new Ci(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new Pi(m,c),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=tu;let d=this.type;this.render=function(w,b,v){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||w.length===0)return;this.type===WE&&(Ve("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=tu);const C=t.getRenderTarget(),R=t.getActiveCubeFace(),P=t.getActiveMipmapLevel(),k=t.state;k.setBlending(Wi),k.buffers.depth.getReversed()===!0?k.buffers.color.setClear(0,0,0,0):k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const $=d!==this.type;$&&b.traverse(function(Q){Q.material&&(Array.isArray(Q.material)?Q.material.forEach(F=>F.needsUpdate=!0):Q.material.needsUpdate=!0)});for(let Q=0,F=w.length;Q<F;Q++){const Z=w[Q],B=Z.shadow;if(B===void 0){Ve("WebGLShadowMap:",Z,"has no shadow.");continue}if(B.autoUpdate===!1&&B.needsUpdate===!1)continue;r.copy(B.mapSize);const U=B.getFrameExtents();r.multiply(U),s.copy(B.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/U.x),r.x=s.x*U.x,B.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/U.y),r.y=s.y*U.y,B.mapSize.y=s.y));const W=t.state.buffers.depth.getReversed();if(B.camera._reversedDepth=W,B.map===null||$===!0){if(B.map!==null&&(B.map.depthTexture!==null&&(B.map.depthTexture.dispose(),B.map.depthTexture=null),B.map.dispose()),this.type===Ka){if(Z.isPointLight){Ve("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}B.map=new bi(r.x,r.y,{format:fs,type:ji,minFilter:hn,magFilter:hn,generateMipmaps:!1}),B.map.texture.name=Z.name+".shadowMap",B.map.depthTexture=new ya(r.x,r.y,Si),B.map.depthTexture.name=Z.name+".shadowMapDepth",B.map.depthTexture.format=Ji,B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=tn,B.map.depthTexture.magFilter=tn}else Z.isPointLight?(B.map=new jx(r.x),B.map.depthTexture=new KT(r.x,Ri)):(B.map=new bi(r.x,r.y),B.map.depthTexture=new ya(r.x,r.y,Ri)),B.map.depthTexture.name=Z.name+".shadowMap",B.map.depthTexture.format=Ji,this.type===tu?(B.map.depthTexture.compareFunction=W?Cp:bp,B.map.depthTexture.minFilter=hn,B.map.depthTexture.magFilter=hn):(B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=tn,B.map.depthTexture.magFilter=tn);B.camera.updateProjectionMatrix()}const j=B.map.isWebGLCubeRenderTarget?6:1;for(let ne=0;ne<j;ne++){if(B.map.isWebGLCubeRenderTarget)t.setRenderTarget(B.map,ne),t.clear();else{ne===0&&(t.setRenderTarget(B.map),t.clear());const le=B.getViewport(ne);a.set(s.x*le.x,s.y*le.y,s.x*le.z,s.y*le.w),k.viewport(a)}if(Z.isPointLight){const le=B.camera,Ze=B.matrix,lt=Z.distance||le.far;lt!==le.far&&(le.far=lt,le.updateProjectionMatrix()),Wa.setFromMatrixPosition(Z.matrixWorld),le.position.copy(Wa),bf.copy(le.position),bf.add(AR[ne]),le.up.copy(bR[ne]),le.lookAt(bf),le.updateMatrixWorld(),Ze.makeTranslation(-Wa.x,-Wa.y,-Wa.z),O_.multiplyMatrices(le.projectionMatrix,le.matrixWorldInverse),B._frustum.setFromProjectionMatrix(O_,le.coordinateSystem,le.reversedDepth)}else B.updateMatrices(Z);i=B.getFrustum(),y(b,v,B.camera,Z,this.type)}B.isPointLightShadow!==!0&&this.type===Ka&&x(B,v),B.needsUpdate=!1}d=this.type,g.needsUpdate=!1,t.setRenderTarget(C,R,P)};function x(w,b){const v=e.update(M);c.defines.VSM_SAMPLES!==w.blurSamples&&(c.defines.VSM_SAMPLES=w.blurSamples,p.defines.VSM_SAMPLES=w.blurSamples,c.needsUpdate=!0,p.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new bi(r.x,r.y,{format:fs,type:ji})),c.uniforms.shadow_pass.value=w.map.depthTexture,c.uniforms.resolution.value=w.mapSize,c.uniforms.radius.value=w.radius,t.setRenderTarget(w.mapPass),t.clear(),t.renderBufferDirect(b,null,v,c,M,null),p.uniforms.shadow_pass.value=w.mapPass.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,t.setRenderTarget(w.map),t.clear(),t.renderBufferDirect(b,null,v,p,M,null)}function S(w,b,v,C){let R=null;const P=v.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(P!==void 0)R=P;else if(R=v.isPointLight===!0?l:o,t.localClippingEnabled&&b.clipShadows===!0&&Array.isArray(b.clippingPlanes)&&b.clippingPlanes.length!==0||b.displacementMap&&b.displacementScale!==0||b.alphaMap&&b.alphaTest>0||b.map&&b.alphaTest>0||b.alphaToCoverage===!0){const k=R.uuid,$=b.uuid;let Q=u[k];Q===void 0&&(Q={},u[k]=Q);let F=Q[$];F===void 0&&(F=R.clone(),Q[$]=F,b.addEventListener("dispose",T)),R=F}if(R.visible=b.visible,R.wireframe=b.wireframe,C===Ka?R.side=b.shadowSide!==null?b.shadowSide:b.side:R.side=b.shadowSide!==null?b.shadowSide:h[b.side],R.alphaMap=b.alphaMap,R.alphaTest=b.alphaToCoverage===!0?.5:b.alphaTest,R.map=b.map,R.clipShadows=b.clipShadows,R.clippingPlanes=b.clippingPlanes,R.clipIntersection=b.clipIntersection,R.displacementMap=b.displacementMap,R.displacementScale=b.displacementScale,R.displacementBias=b.displacementBias,R.wireframeLinewidth=b.wireframeLinewidth,R.linewidth=b.linewidth,v.isPointLight===!0&&R.isMeshDistanceMaterial===!0){const k=t.properties.get(R);k.light=v}return R}function y(w,b,v,C,R){if(w.visible===!1)return;if(w.layers.test(b.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&R===Ka)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,w.matrixWorld);const $=e.update(w),Q=w.material;if(Array.isArray(Q)){const F=$.groups;for(let Z=0,B=F.length;Z<B;Z++){const U=F[Z],W=Q[U.materialIndex];if(W&&W.visible){const j=S(w,W,C,R);w.onBeforeShadow(t,w,b,v,$,j,U),t.renderBufferDirect(v,null,$,j,w,U),w.onAfterShadow(t,w,b,v,$,j,U)}}}else if(Q.visible){const F=S(w,Q,C,R);w.onBeforeShadow(t,w,b,v,$,F,null),t.renderBufferDirect(v,null,$,F,w,null),w.onAfterShadow(t,w,b,v,$,F,null)}}const k=w.children;for(let $=0,Q=k.length;$<Q;$++)y(k[$],b,v,C,R)}function T(w){w.target.removeEventListener("dispose",T);for(const v in u){const C=u[v],R=w.target.uuid;R in C&&(C[R].dispose(),delete C[R])}}}function RR(t,e){function n(){let D=!1;const he=new Nt;let K=null;const ge=new Nt(0,0,0,0);return{setMask:function(Ee){K!==Ee&&!D&&(t.colorMask(Ee,Ee,Ee,Ee),K=Ee)},setLocked:function(Ee){D=Ee},setClear:function(Ee,te,Ne,Re,Ot){Ot===!0&&(Ee*=Re,te*=Re,Ne*=Re),he.set(Ee,te,Ne,Re),ge.equals(he)===!1&&(t.clearColor(Ee,te,Ne,Re),ge.copy(he))},reset:function(){D=!1,K=null,ge.set(-1,0,0,0)}}}function i(){let D=!1,he=!1,K=null,ge=null,Ee=null;return{setReversed:function(te){if(he!==te){const Ne=e.get("EXT_clip_control");te?Ne.clipControlEXT(Ne.LOWER_LEFT_EXT,Ne.ZERO_TO_ONE_EXT):Ne.clipControlEXT(Ne.LOWER_LEFT_EXT,Ne.NEGATIVE_ONE_TO_ONE_EXT),he=te;const Re=Ee;Ee=null,this.setClear(Re)}},getReversed:function(){return he},setTest:function(te){te?se(t.DEPTH_TEST):Oe(t.DEPTH_TEST)},setMask:function(te){K!==te&&!D&&(t.depthMask(te),K=te)},setFunc:function(te){if(he&&(te=ET[te]),ge!==te){switch(te){case Ld:t.depthFunc(t.NEVER);break;case Nd:t.depthFunc(t.ALWAYS);break;case Dd:t.depthFunc(t.LESS);break;case va:t.depthFunc(t.LEQUAL);break;case Id:t.depthFunc(t.EQUAL);break;case Ud:t.depthFunc(t.GEQUAL);break;case Od:t.depthFunc(t.GREATER);break;case Fd:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ge=te}},setLocked:function(te){D=te},setClear:function(te){Ee!==te&&(Ee=te,he&&(te=1-te),t.clearDepth(te))},reset:function(){D=!1,K=null,ge=null,Ee=null,he=!1}}}function r(){let D=!1,he=null,K=null,ge=null,Ee=null,te=null,Ne=null,Re=null,Ot=null;return{setTest:function(Et){D||(Et?se(t.STENCIL_TEST):Oe(t.STENCIL_TEST))},setMask:function(Et){he!==Et&&!D&&(t.stencilMask(Et),he=Et)},setFunc:function(Et,fi,di){(K!==Et||ge!==fi||Ee!==di)&&(t.stencilFunc(Et,fi,di),K=Et,ge=fi,Ee=di)},setOp:function(Et,fi,di){(te!==Et||Ne!==fi||Re!==di)&&(t.stencilOp(Et,fi,di),te=Et,Ne=fi,Re=di)},setLocked:function(Et){D=Et},setClear:function(Et){Ot!==Et&&(t.clearStencil(Et),Ot=Et)},reset:function(){D=!1,he=null,K=null,ge=null,Ee=null,te=null,Ne=null,Re=null,Ot=null}}}const s=new n,a=new i,o=new r,l=new WeakMap,u=new WeakMap;let f={},h={},c={},p=new WeakMap,m=[],M=null,g=!1,d=null,x=null,S=null,y=null,T=null,w=null,b=null,v=new at(0,0,0),C=0,R=!1,P=null,k=null,$=null,Q=null,F=null;const Z=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,U=0;const W=t.getParameter(t.VERSION);W.indexOf("WebGL")!==-1?(U=parseFloat(/^WebGL (\d)/.exec(W)[1]),B=U>=1):W.indexOf("OpenGL ES")!==-1&&(U=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),B=U>=2);let j=null,ne={};const le=t.getParameter(t.SCISSOR_BOX),Ze=t.getParameter(t.VIEWPORT),lt=new Nt().fromArray(le),it=new Nt().fromArray(Ze);function q(D,he,K,ge){const Ee=new Uint8Array(4),te=t.createTexture();t.bindTexture(D,te),t.texParameteri(D,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(D,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Ne=0;Ne<K;Ne++)D===t.TEXTURE_3D||D===t.TEXTURE_2D_ARRAY?t.texImage3D(he,0,t.RGBA,1,1,ge,0,t.RGBA,t.UNSIGNED_BYTE,Ee):t.texImage2D(he+Ne,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,Ee);return te}const fe={};fe[t.TEXTURE_2D]=q(t.TEXTURE_2D,t.TEXTURE_2D,1),fe[t.TEXTURE_CUBE_MAP]=q(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),fe[t.TEXTURE_2D_ARRAY]=q(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),fe[t.TEXTURE_3D]=q(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),se(t.DEPTH_TEST),a.setFunc(va),ye(!1),_e(Ag),se(t.CULL_FACE),re(Wi);function se(D){f[D]!==!0&&(t.enable(D),f[D]=!0)}function Oe(D){f[D]!==!1&&(t.disable(D),f[D]=!1)}function We(D,he){return c[D]!==he?(t.bindFramebuffer(D,he),c[D]=he,D===t.DRAW_FRAMEBUFFER&&(c[t.FRAMEBUFFER]=he),D===t.FRAMEBUFFER&&(c[t.DRAW_FRAMEBUFFER]=he),!0):!1}function Be(D,he){let K=m,ge=!1;if(D){K=p.get(he),K===void 0&&(K=[],p.set(he,K));const Ee=D.textures;if(K.length!==Ee.length||K[0]!==t.COLOR_ATTACHMENT0){for(let te=0,Ne=Ee.length;te<Ne;te++)K[te]=t.COLOR_ATTACHMENT0+te;K.length=Ee.length,ge=!0}}else K[0]!==t.BACK&&(K[0]=t.BACK,ge=!0);ge&&t.drawBuffers(K)}function mt(D){return M!==D?(t.useProgram(D),M=D,!0):!1}const Ye={[qr]:t.FUNC_ADD,[YE]:t.FUNC_SUBTRACT,[ZE]:t.FUNC_REVERSE_SUBTRACT};Ye[$E]=t.MIN,Ye[qE]=t.MAX;const ee={[KE]:t.ZERO,[jE]:t.ONE,[JE]:t.SRC_COLOR,[Rd]:t.SRC_ALPHA,[rT]:t.SRC_ALPHA_SATURATE,[nT]:t.DST_COLOR,[eT]:t.DST_ALPHA,[QE]:t.ONE_MINUS_SRC_COLOR,[Pd]:t.ONE_MINUS_SRC_ALPHA,[iT]:t.ONE_MINUS_DST_COLOR,[tT]:t.ONE_MINUS_DST_ALPHA,[sT]:t.CONSTANT_COLOR,[aT]:t.ONE_MINUS_CONSTANT_COLOR,[oT]:t.CONSTANT_ALPHA,[lT]:t.ONE_MINUS_CONSTANT_ALPHA};function re(D,he,K,ge,Ee,te,Ne,Re,Ot,Et){if(D===Wi){g===!0&&(Oe(t.BLEND),g=!1);return}if(g===!1&&(se(t.BLEND),g=!0),D!==XE){if(D!==d||Et!==R){if((x!==qr||T!==qr)&&(t.blendEquation(t.FUNC_ADD),x=qr,T=qr),Et)switch(D){case ia:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case bg:t.blendFunc(t.ONE,t.ONE);break;case Cg:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Rg:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:ct("WebGLState: Invalid blending: ",D);break}else switch(D){case ia:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case bg:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case Cg:ct("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Rg:ct("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ct("WebGLState: Invalid blending: ",D);break}S=null,y=null,w=null,b=null,v.set(0,0,0),C=0,d=D,R=Et}return}Ee=Ee||he,te=te||K,Ne=Ne||ge,(he!==x||Ee!==T)&&(t.blendEquationSeparate(Ye[he],Ye[Ee]),x=he,T=Ee),(K!==S||ge!==y||te!==w||Ne!==b)&&(t.blendFuncSeparate(ee[K],ee[ge],ee[te],ee[Ne]),S=K,y=ge,w=te,b=Ne),(Re.equals(v)===!1||Ot!==C)&&(t.blendColor(Re.r,Re.g,Re.b,Ot),v.copy(Re),C=Ot),d=D,R=!1}function ie(D,he){D.side===yi?Oe(t.CULL_FACE):se(t.CULL_FACE);let K=D.side===Rn;he&&(K=!K),ye(K),D.blending===ia&&D.transparent===!1?re(Wi):re(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),s.setMask(D.colorWrite);const ge=D.stencilWrite;o.setTest(ge),ge&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),De(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?se(t.SAMPLE_ALPHA_TO_COVERAGE):Oe(t.SAMPLE_ALPHA_TO_COVERAGE)}function ye(D){P!==D&&(D?t.frontFace(t.CW):t.frontFace(t.CCW),P=D)}function _e(D){D!==HE?(se(t.CULL_FACE),D!==k&&(D===Ag?t.cullFace(t.BACK):D===GE?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Oe(t.CULL_FACE),k=D}function ze(D){D!==$&&(B&&t.lineWidth(D),$=D)}function De(D,he,K){D?(se(t.POLYGON_OFFSET_FILL),(Q!==he||F!==K)&&(Q=he,F=K,a.getReversed()&&(he=-he),t.polygonOffset(he,K))):Oe(t.POLYGON_OFFSET_FILL)}function Xe(D){D?se(t.SCISSOR_TEST):Oe(t.SCISSOR_TEST)}function $e(D){D===void 0&&(D=t.TEXTURE0+Z-1),j!==D&&(t.activeTexture(D),j=D)}function L(D,he,K){K===void 0&&(j===null?K=t.TEXTURE0+Z-1:K=j);let ge=ne[K];ge===void 0&&(ge={type:void 0,texture:void 0},ne[K]=ge),(ge.type!==D||ge.texture!==he)&&(j!==K&&(t.activeTexture(K),j=K),t.bindTexture(D,he||fe[D]),ge.type=D,ge.texture=he)}function vt(){const D=ne[j];D!==void 0&&D.type!==void 0&&(t.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function st(){try{t.compressedTexImage2D(...arguments)}catch(D){ct("WebGLState:",D)}}function A(){try{t.compressedTexImage3D(...arguments)}catch(D){ct("WebGLState:",D)}}function _(){try{t.texSubImage2D(...arguments)}catch(D){ct("WebGLState:",D)}}function O(){try{t.texSubImage3D(...arguments)}catch(D){ct("WebGLState:",D)}}function H(){try{t.compressedTexSubImage2D(...arguments)}catch(D){ct("WebGLState:",D)}}function X(){try{t.compressedTexSubImage3D(...arguments)}catch(D){ct("WebGLState:",D)}}function ue(){try{t.texStorage2D(...arguments)}catch(D){ct("WebGLState:",D)}}function de(){try{t.texStorage3D(...arguments)}catch(D){ct("WebGLState:",D)}}function Y(){try{t.texImage2D(...arguments)}catch(D){ct("WebGLState:",D)}}function J(){try{t.texImage3D(...arguments)}catch(D){ct("WebGLState:",D)}}function pe(D){return h[D]!==void 0?h[D]:t.getParameter(D)}function Ie(D,he){h[D]!==he&&(t.pixelStorei(D,he),h[D]=he)}function ve(D){lt.equals(D)===!1&&(t.scissor(D.x,D.y,D.z,D.w),lt.copy(D))}function me(D){it.equals(D)===!1&&(t.viewport(D.x,D.y,D.z,D.w),it.copy(D))}function ke(D,he){let K=u.get(he);K===void 0&&(K=new WeakMap,u.set(he,K));let ge=K.get(D);ge===void 0&&(ge=t.getUniformBlockIndex(he,D.name),K.set(D,ge))}function He(D,he){const ge=u.get(he).get(D);l.get(he)!==ge&&(t.uniformBlockBinding(he,ge,D.__bindingPointIndex),l.set(he,ge))}function Je(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),a.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),f={},h={},j=null,ne={},c={},p=new WeakMap,m=[],M=null,g=!1,d=null,x=null,S=null,y=null,T=null,w=null,b=null,v=new at(0,0,0),C=0,R=!1,P=null,k=null,$=null,Q=null,F=null,lt.set(0,0,t.canvas.width,t.canvas.height),it.set(0,0,t.canvas.width,t.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:se,disable:Oe,bindFramebuffer:We,drawBuffers:Be,useProgram:mt,setBlending:re,setMaterial:ie,setFlipSided:ye,setCullFace:_e,setLineWidth:ze,setPolygonOffset:De,setScissorTest:Xe,activeTexture:$e,bindTexture:L,unbindTexture:vt,compressedTexImage2D:st,compressedTexImage3D:A,texImage2D:Y,texImage3D:J,pixelStorei:Ie,getParameter:pe,updateUBOMapping:ke,uniformBlockBinding:He,texStorage2D:ue,texStorage3D:de,texSubImage2D:_,texSubImage3D:O,compressedTexSubImage2D:H,compressedTexSubImage3D:X,scissor:ve,viewport:me,reset:Je}}function PR(t,e,n,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new ce,f=new WeakMap,h=new Set;let c;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(A,_){return m?new OffscreenCanvas(A,_):zu("canvas")}function g(A,_,O){let H=1;const X=st(A);if((X.width>O||X.height>O)&&(H=O/Math.max(X.width,X.height)),H<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const ue=Math.floor(H*X.width),de=Math.floor(H*X.height);c===void 0&&(c=M(ue,de));const Y=_?M(ue,de):c;return Y.width=ue,Y.height=de,Y.getContext("2d").drawImage(A,0,0,ue,de),Ve("WebGLRenderer: Texture has been resized from ("+X.width+"x"+X.height+") to ("+ue+"x"+de+")."),Y}else return"data"in A&&Ve("WebGLRenderer: Image in DataTexture is too big ("+X.width+"x"+X.height+")."),A;return A}function d(A){return A.generateMipmaps}function x(A){t.generateMipmap(A)}function S(A){return A.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?t.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function y(A,_,O,H,X,ue=!1){if(A!==null){if(t[A]!==void 0)return t[A];Ve("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let de;H&&(de=e.get("EXT_texture_norm16"),de||Ve("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Y=_;if(_===t.RED&&(O===t.FLOAT&&(Y=t.R32F),O===t.HALF_FLOAT&&(Y=t.R16F),O===t.UNSIGNED_BYTE&&(Y=t.R8),O===t.UNSIGNED_SHORT&&de&&(Y=de.R16_EXT),O===t.SHORT&&de&&(Y=de.R16_SNORM_EXT)),_===t.RED_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.R8UI),O===t.UNSIGNED_SHORT&&(Y=t.R16UI),O===t.UNSIGNED_INT&&(Y=t.R32UI),O===t.BYTE&&(Y=t.R8I),O===t.SHORT&&(Y=t.R16I),O===t.INT&&(Y=t.R32I)),_===t.RG&&(O===t.FLOAT&&(Y=t.RG32F),O===t.HALF_FLOAT&&(Y=t.RG16F),O===t.UNSIGNED_BYTE&&(Y=t.RG8),O===t.UNSIGNED_SHORT&&de&&(Y=de.RG16_EXT),O===t.SHORT&&de&&(Y=de.RG16_SNORM_EXT)),_===t.RG_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RG8UI),O===t.UNSIGNED_SHORT&&(Y=t.RG16UI),O===t.UNSIGNED_INT&&(Y=t.RG32UI),O===t.BYTE&&(Y=t.RG8I),O===t.SHORT&&(Y=t.RG16I),O===t.INT&&(Y=t.RG32I)),_===t.RGB_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RGB8UI),O===t.UNSIGNED_SHORT&&(Y=t.RGB16UI),O===t.UNSIGNED_INT&&(Y=t.RGB32UI),O===t.BYTE&&(Y=t.RGB8I),O===t.SHORT&&(Y=t.RGB16I),O===t.INT&&(Y=t.RGB32I)),_===t.RGBA_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RGBA8UI),O===t.UNSIGNED_SHORT&&(Y=t.RGBA16UI),O===t.UNSIGNED_INT&&(Y=t.RGBA32UI),O===t.BYTE&&(Y=t.RGBA8I),O===t.SHORT&&(Y=t.RGBA16I),O===t.INT&&(Y=t.RGBA32I)),_===t.RGB&&(O===t.UNSIGNED_SHORT&&de&&(Y=de.RGB16_EXT),O===t.SHORT&&de&&(Y=de.RGB16_SNORM_EXT),O===t.UNSIGNED_INT_5_9_9_9_REV&&(Y=t.RGB9_E5),O===t.UNSIGNED_INT_10F_11F_11F_REV&&(Y=t.R11F_G11F_B10F)),_===t.RGBA){const J=ue?Bu:ut.getTransfer(X);O===t.FLOAT&&(Y=t.RGBA32F),O===t.HALF_FLOAT&&(Y=t.RGBA16F),O===t.UNSIGNED_BYTE&&(Y=J===gt?t.SRGB8_ALPHA8:t.RGBA8),O===t.UNSIGNED_SHORT&&de&&(Y=de.RGBA16_EXT),O===t.SHORT&&de&&(Y=de.RGBA16_SNORM_EXT),O===t.UNSIGNED_SHORT_4_4_4_4&&(Y=t.RGBA4),O===t.UNSIGNED_SHORT_5_5_5_1&&(Y=t.RGB5_A1)}return(Y===t.R16F||Y===t.R32F||Y===t.RG16F||Y===t.RG32F||Y===t.RGBA16F||Y===t.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function T(A,_){let O;return A?_===null||_===Ri||_===No?O=t.DEPTH24_STENCIL8:_===Si?O=t.DEPTH32F_STENCIL8:_===Lo&&(O=t.DEPTH24_STENCIL8,Ve("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Ri||_===No?O=t.DEPTH_COMPONENT24:_===Si?O=t.DEPTH_COMPONENT32F:_===Lo&&(O=t.DEPTH_COMPONENT16),O}function w(A,_){return d(A)===!0||A.isFramebufferTexture&&A.minFilter!==tn&&A.minFilter!==hn?Math.log2(Math.max(_.width,_.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?_.mipmaps.length:1}function b(A){const _=A.target;_.removeEventListener("dispose",b),C(_),_.isVideoTexture&&f.delete(_),_.isHTMLTexture&&h.delete(_)}function v(A){const _=A.target;_.removeEventListener("dispose",v),P(_)}function C(A){const _=i.get(A);if(_.__webglInit===void 0)return;const O=A.source,H=p.get(O);if(H){const X=H[_.__cacheKey];X.usedTimes--,X.usedTimes===0&&R(A),Object.keys(H).length===0&&p.delete(O)}i.remove(A)}function R(A){const _=i.get(A);t.deleteTexture(_.__webglTexture);const O=A.source,H=p.get(O);delete H[_.__cacheKey],a.memory.textures--}function P(A){const _=i.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),i.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let H=0;H<6;H++){if(Array.isArray(_.__webglFramebuffer[H]))for(let X=0;X<_.__webglFramebuffer[H].length;X++)t.deleteFramebuffer(_.__webglFramebuffer[H][X]);else t.deleteFramebuffer(_.__webglFramebuffer[H]);_.__webglDepthbuffer&&t.deleteRenderbuffer(_.__webglDepthbuffer[H])}else{if(Array.isArray(_.__webglFramebuffer))for(let H=0;H<_.__webglFramebuffer.length;H++)t.deleteFramebuffer(_.__webglFramebuffer[H]);else t.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&t.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&t.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let H=0;H<_.__webglColorRenderbuffer.length;H++)_.__webglColorRenderbuffer[H]&&t.deleteRenderbuffer(_.__webglColorRenderbuffer[H]);_.__webglDepthRenderbuffer&&t.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const O=A.textures;for(let H=0,X=O.length;H<X;H++){const ue=i.get(O[H]);ue.__webglTexture&&(t.deleteTexture(ue.__webglTexture),a.memory.textures--),i.remove(O[H])}i.remove(A)}let k=0;function $(){k=0}function Q(){return k}function F(A){k=A}function Z(){const A=k;return A>=r.maxTextures&&Ve("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+r.maxTextures),k+=1,A}function B(A){const _=[];return _.push(A.wrapS),_.push(A.wrapT),_.push(A.wrapR||0),_.push(A.magFilter),_.push(A.minFilter),_.push(A.anisotropy),_.push(A.internalFormat),_.push(A.format),_.push(A.type),_.push(A.generateMipmaps),_.push(A.premultiplyAlpha),_.push(A.flipY),_.push(A.unpackAlignment),_.push(A.colorSpace),_.join()}function U(A,_){const O=i.get(A);if(A.isVideoTexture&&L(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&O.__version!==A.version){const H=A.image;if(H===null)Ve("WebGLRenderer: Texture marked for update but no image data found.");else if(H.complete===!1)Ve("WebGLRenderer: Texture marked for update but image is incomplete");else{Oe(O,A,_);return}}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,O.__webglTexture,t.TEXTURE0+_)}function W(A,_){const O=i.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){Oe(O,A,_);return}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,O.__webglTexture,t.TEXTURE0+_)}function j(A,_){const O=i.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){Oe(O,A,_);return}n.bindTexture(t.TEXTURE_3D,O.__webglTexture,t.TEXTURE0+_)}function ne(A,_){const O=i.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&O.__version!==A.version){We(O,A,_);return}n.bindTexture(t.TEXTURE_CUBE_MAP,O.__webglTexture,t.TEXTURE0+_)}const le={[kd]:t.REPEAT,[Hi]:t.CLAMP_TO_EDGE,[Bd]:t.MIRRORED_REPEAT},Ze={[tn]:t.NEAREST,[fT]:t.NEAREST_MIPMAP_NEAREST,[fl]:t.NEAREST_MIPMAP_LINEAR,[hn]:t.LINEAR,[Xc]:t.LINEAR_MIPMAP_NEAREST,[es]:t.LINEAR_MIPMAP_LINEAR},lt={[pT]:t.NEVER,[xT]:t.ALWAYS,[mT]:t.LESS,[bp]:t.LEQUAL,[gT]:t.EQUAL,[Cp]:t.GEQUAL,[_T]:t.GREATER,[vT]:t.NOTEQUAL};function it(A,_){if(_.type===Si&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===hn||_.magFilter===Xc||_.magFilter===fl||_.magFilter===es||_.minFilter===hn||_.minFilter===Xc||_.minFilter===fl||_.minFilter===es)&&Ve("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(A,t.TEXTURE_WRAP_S,le[_.wrapS]),t.texParameteri(A,t.TEXTURE_WRAP_T,le[_.wrapT]),(A===t.TEXTURE_3D||A===t.TEXTURE_2D_ARRAY)&&t.texParameteri(A,t.TEXTURE_WRAP_R,le[_.wrapR]),t.texParameteri(A,t.TEXTURE_MAG_FILTER,Ze[_.magFilter]),t.texParameteri(A,t.TEXTURE_MIN_FILTER,Ze[_.minFilter]),_.compareFunction&&(t.texParameteri(A,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(A,t.TEXTURE_COMPARE_FUNC,lt[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===tn||_.minFilter!==fl&&_.minFilter!==es||_.type===Si&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||i.get(_).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");t.texParameterf(A,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),i.get(_).__currentAnisotropy=_.anisotropy}}}function q(A,_){let O=!1;A.__webglInit===void 0&&(A.__webglInit=!0,_.addEventListener("dispose",b));const H=_.source;let X=p.get(H);X===void 0&&(X={},p.set(H,X));const ue=B(_);if(ue!==A.__cacheKey){X[ue]===void 0&&(X[ue]={texture:t.createTexture(),usedTimes:0},a.memory.textures++,O=!0),X[ue].usedTimes++;const de=X[A.__cacheKey];de!==void 0&&(X[A.__cacheKey].usedTimes--,de.usedTimes===0&&R(_)),A.__cacheKey=ue,A.__webglTexture=X[ue].texture}return O}function fe(A,_,O){return Math.floor(Math.floor(A/O)/_)}function se(A,_,O,H){const ue=A.updateRanges;if(ue.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,_.width,_.height,O,H,_.data);else{ue.sort((Ie,ve)=>Ie.start-ve.start);let de=0;for(let Ie=1;Ie<ue.length;Ie++){const ve=ue[de],me=ue[Ie],ke=ve.start+ve.count,He=fe(me.start,_.width,4),Je=fe(ve.start,_.width,4);me.start<=ke+1&&He===Je&&fe(me.start+me.count-1,_.width,4)===He?ve.count=Math.max(ve.count,me.start+me.count-ve.start):(++de,ue[de]=me)}ue.length=de+1;const Y=n.getParameter(t.UNPACK_ROW_LENGTH),J=n.getParameter(t.UNPACK_SKIP_PIXELS),pe=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,_.width);for(let Ie=0,ve=ue.length;Ie<ve;Ie++){const me=ue[Ie],ke=Math.floor(me.start/4),He=Math.ceil(me.count/4),Je=ke%_.width,D=Math.floor(ke/_.width),he=He,K=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,Je),n.pixelStorei(t.UNPACK_SKIP_ROWS,D),n.texSubImage2D(t.TEXTURE_2D,0,Je,D,he,K,O,H,_.data)}A.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,Y),n.pixelStorei(t.UNPACK_SKIP_PIXELS,J),n.pixelStorei(t.UNPACK_SKIP_ROWS,pe)}}function Oe(A,_,O){let H=t.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(H=t.TEXTURE_2D_ARRAY),_.isData3DTexture&&(H=t.TEXTURE_3D);const X=q(A,_),ue=_.source;n.bindTexture(H,A.__webglTexture,t.TEXTURE0+O);const de=i.get(ue);if(ue.version!==de.__version||X===!0){if(n.activeTexture(t.TEXTURE0+O),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){const K=ut.getPrimaries(ut.workingColorSpace),ge=_.colorSpace===_r?null:ut.getPrimaries(_.colorSpace),Ee=_.colorSpace===_r||K===ge?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee)}n.pixelStorei(t.UNPACK_ALIGNMENT,_.unpackAlignment);let J=g(_.image,!1,r.maxTextureSize);J=vt(_,J);const pe=s.convert(_.format,_.colorSpace),Ie=s.convert(_.type);let ve=y(_.internalFormat,pe,Ie,_.normalized,_.colorSpace,_.isVideoTexture);it(H,_);let me;const ke=_.mipmaps,He=_.isVideoTexture!==!0,Je=de.__version===void 0||X===!0,D=ue.dataReady,he=w(_,J);if(_.isDepthTexture)ve=T(_.format===ts,_.type),Je&&(He?n.texStorage2D(t.TEXTURE_2D,1,ve,J.width,J.height):n.texImage2D(t.TEXTURE_2D,0,ve,J.width,J.height,0,pe,Ie,null));else if(_.isDataTexture)if(ke.length>0){He&&Je&&n.texStorage2D(t.TEXTURE_2D,he,ve,ke[0].width,ke[0].height);for(let K=0,ge=ke.length;K<ge;K++)me=ke[K],He?D&&n.texSubImage2D(t.TEXTURE_2D,K,0,0,me.width,me.height,pe,Ie,me.data):n.texImage2D(t.TEXTURE_2D,K,ve,me.width,me.height,0,pe,Ie,me.data);_.generateMipmaps=!1}else He?(Je&&n.texStorage2D(t.TEXTURE_2D,he,ve,J.width,J.height),D&&se(_,J,pe,Ie)):n.texImage2D(t.TEXTURE_2D,0,ve,J.width,J.height,0,pe,Ie,J.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){He&&Je&&n.texStorage3D(t.TEXTURE_2D_ARRAY,he,ve,ke[0].width,ke[0].height,J.depth);for(let K=0,ge=ke.length;K<ge;K++)if(me=ke[K],_.format!==oi)if(pe!==null)if(He){if(D)if(_.layerUpdates.size>0){const Ee=h_(me.width,me.height,_.format,_.type);for(const te of _.layerUpdates){const Ne=me.data.subarray(te*Ee/me.data.BYTES_PER_ELEMENT,(te+1)*Ee/me.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,K,0,0,te,me.width,me.height,1,pe,Ne)}_.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,K,0,0,0,me.width,me.height,J.depth,pe,me.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,K,ve,me.width,me.height,J.depth,0,me.data,0,0);else Ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else He?D&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,K,0,0,0,me.width,me.height,J.depth,pe,Ie,me.data):n.texImage3D(t.TEXTURE_2D_ARRAY,K,ve,me.width,me.height,J.depth,0,pe,Ie,me.data)}else{He&&Je&&n.texStorage2D(t.TEXTURE_2D,he,ve,ke[0].width,ke[0].height);for(let K=0,ge=ke.length;K<ge;K++)me=ke[K],_.format!==oi?pe!==null?He?D&&n.compressedTexSubImage2D(t.TEXTURE_2D,K,0,0,me.width,me.height,pe,me.data):n.compressedTexImage2D(t.TEXTURE_2D,K,ve,me.width,me.height,0,me.data):Ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):He?D&&n.texSubImage2D(t.TEXTURE_2D,K,0,0,me.width,me.height,pe,Ie,me.data):n.texImage2D(t.TEXTURE_2D,K,ve,me.width,me.height,0,pe,Ie,me.data)}else if(_.isDataArrayTexture)if(He){if(Je&&n.texStorage3D(t.TEXTURE_2D_ARRAY,he,ve,J.width,J.height,J.depth),D)if(_.layerUpdates.size>0){const K=h_(J.width,J.height,_.format,_.type);for(const ge of _.layerUpdates){const Ee=J.data.subarray(ge*K/J.data.BYTES_PER_ELEMENT,(ge+1)*K/J.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,ge,J.width,J.height,1,pe,Ie,Ee)}_.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,pe,Ie,J.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,ve,J.width,J.height,J.depth,0,pe,Ie,J.data);else if(_.isData3DTexture)He?(Je&&n.texStorage3D(t.TEXTURE_3D,he,ve,J.width,J.height,J.depth),D&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,pe,Ie,J.data)):n.texImage3D(t.TEXTURE_3D,0,ve,J.width,J.height,J.depth,0,pe,Ie,J.data);else if(_.isFramebufferTexture){if(Je)if(He)n.texStorage2D(t.TEXTURE_2D,he,ve,J.width,J.height);else{let K=J.width,ge=J.height;for(let Ee=0;Ee<he;Ee++)n.texImage2D(t.TEXTURE_2D,Ee,ve,K,ge,0,pe,Ie,null),K>>=1,ge>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in t){const K=t.canvas;if(K.hasAttribute("layoutsubtree")||K.setAttribute("layoutsubtree","true"),J.parentNode!==K){K.appendChild(J),h.add(_),K.onpaint=ge=>{const Ee=ge.changedElements;for(const te of h)Ee.includes(te.image)&&(te.needsUpdate=!0)},K.requestPaint();return}if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,J);else{const Ee=t.RGBA,te=t.RGBA,Ne=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,Ee,te,Ne,J)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(ke.length>0){if(He&&Je){const K=st(ke[0]);n.texStorage2D(t.TEXTURE_2D,he,ve,K.width,K.height)}for(let K=0,ge=ke.length;K<ge;K++)me=ke[K],He?D&&n.texSubImage2D(t.TEXTURE_2D,K,0,0,pe,Ie,me):n.texImage2D(t.TEXTURE_2D,K,ve,pe,Ie,me);_.generateMipmaps=!1}else if(He){if(Je){const K=st(J);n.texStorage2D(t.TEXTURE_2D,he,ve,K.width,K.height)}D&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,pe,Ie,J)}else n.texImage2D(t.TEXTURE_2D,0,ve,pe,Ie,J);d(_)&&x(H),de.__version=ue.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function We(A,_,O){if(_.image.length!==6)return;const H=q(A,_),X=_.source;n.bindTexture(t.TEXTURE_CUBE_MAP,A.__webglTexture,t.TEXTURE0+O);const ue=i.get(X);if(X.version!==ue.__version||H===!0){n.activeTexture(t.TEXTURE0+O);const de=ut.getPrimaries(ut.workingColorSpace),Y=_.colorSpace===_r?null:ut.getPrimaries(_.colorSpace),J=_.colorSpace===_r||de===Y?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,_.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,J);const pe=_.isCompressedTexture||_.image[0].isCompressedTexture,Ie=_.image[0]&&_.image[0].isDataTexture,ve=[];for(let te=0;te<6;te++)!pe&&!Ie?ve[te]=g(_.image[te],!0,r.maxCubemapSize):ve[te]=Ie?_.image[te].image:_.image[te],ve[te]=vt(_,ve[te]);const me=ve[0],ke=s.convert(_.format,_.colorSpace),He=s.convert(_.type),Je=y(_.internalFormat,ke,He,_.normalized,_.colorSpace),D=_.isVideoTexture!==!0,he=ue.__version===void 0||H===!0,K=X.dataReady;let ge=w(_,me);it(t.TEXTURE_CUBE_MAP,_);let Ee;if(pe){D&&he&&n.texStorage2D(t.TEXTURE_CUBE_MAP,ge,Je,me.width,me.height);for(let te=0;te<6;te++){Ee=ve[te].mipmaps;for(let Ne=0;Ne<Ee.length;Ne++){const Re=Ee[Ne];_.format!==oi?ke!==null?D?K&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne,0,0,Re.width,Re.height,ke,Re.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne,Je,Re.width,Re.height,0,Re.data):Ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?K&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne,0,0,Re.width,Re.height,ke,He,Re.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne,Je,Re.width,Re.height,0,ke,He,Re.data)}}}else{if(Ee=_.mipmaps,D&&he){Ee.length>0&&ge++;const te=st(ve[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,ge,Je,te.width,te.height)}for(let te=0;te<6;te++)if(Ie){D?K&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,ve[te].width,ve[te].height,ke,He,ve[te].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,Je,ve[te].width,ve[te].height,0,ke,He,ve[te].data);for(let Ne=0;Ne<Ee.length;Ne++){const Ot=Ee[Ne].image[te].image;D?K&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne+1,0,0,Ot.width,Ot.height,ke,He,Ot.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne+1,Je,Ot.width,Ot.height,0,ke,He,Ot.data)}}else{D?K&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,ke,He,ve[te]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,Je,ke,He,ve[te]);for(let Ne=0;Ne<Ee.length;Ne++){const Re=Ee[Ne];D?K&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne+1,0,0,ke,He,Re.image[te]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne+1,Je,ke,He,Re.image[te])}}}d(_)&&x(t.TEXTURE_CUBE_MAP),ue.__version=X.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function Be(A,_,O,H,X,ue){const de=s.convert(O.format,O.colorSpace),Y=s.convert(O.type),J=y(O.internalFormat,de,Y,O.normalized,O.colorSpace),pe=i.get(_),Ie=i.get(O);if(Ie.__renderTarget=_,!pe.__hasExternalTextures){const ve=Math.max(1,_.width>>ue),me=Math.max(1,_.height>>ue);X===t.TEXTURE_3D||X===t.TEXTURE_2D_ARRAY?n.texImage3D(X,ue,J,ve,me,_.depth,0,de,Y,null):n.texImage2D(X,ue,J,ve,me,0,de,Y,null)}n.bindFramebuffer(t.FRAMEBUFFER,A),$e(_)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,H,X,Ie.__webglTexture,0,Xe(_)):(X===t.TEXTURE_2D||X>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&X<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,H,X,Ie.__webglTexture,ue),n.bindFramebuffer(t.FRAMEBUFFER,null)}function mt(A,_,O){if(t.bindRenderbuffer(t.RENDERBUFFER,A),_.depthBuffer){const H=_.depthTexture,X=H&&H.isDepthTexture?H.type:null,ue=T(_.stencilBuffer,X),de=_.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;$e(_)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Xe(_),ue,_.width,_.height):O?t.renderbufferStorageMultisample(t.RENDERBUFFER,Xe(_),ue,_.width,_.height):t.renderbufferStorage(t.RENDERBUFFER,ue,_.width,_.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,de,t.RENDERBUFFER,A)}else{const H=_.textures;for(let X=0;X<H.length;X++){const ue=H[X],de=s.convert(ue.format,ue.colorSpace),Y=s.convert(ue.type),J=y(ue.internalFormat,de,Y,ue.normalized,ue.colorSpace);$e(_)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Xe(_),J,_.width,_.height):O?t.renderbufferStorageMultisample(t.RENDERBUFFER,Xe(_),J,_.width,_.height):t.renderbufferStorage(t.RENDERBUFFER,J,_.width,_.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Ye(A,_,O){const H=_.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,A),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const X=i.get(_.depthTexture);if(X.__renderTarget=_,(!X.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),H){if(X.__webglInit===void 0&&(X.__webglInit=!0,_.depthTexture.addEventListener("dispose",b)),X.__webglTexture===void 0){X.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,X.__webglTexture),it(t.TEXTURE_CUBE_MAP,_.depthTexture);const pe=s.convert(_.depthTexture.format),Ie=s.convert(_.depthTexture.type);let ve;_.depthTexture.format===Ji?ve=t.DEPTH_COMPONENT24:_.depthTexture.format===ts&&(ve=t.DEPTH24_STENCIL8);for(let me=0;me<6;me++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,ve,_.width,_.height,0,pe,Ie,null)}}else U(_.depthTexture,0);const ue=X.__webglTexture,de=Xe(_),Y=H?t.TEXTURE_CUBE_MAP_POSITIVE_X+O:t.TEXTURE_2D,J=_.depthTexture.format===ts?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(_.depthTexture.format===Ji)$e(_)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,J,Y,ue,0,de):t.framebufferTexture2D(t.FRAMEBUFFER,J,Y,ue,0);else if(_.depthTexture.format===ts)$e(_)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,J,Y,ue,0,de):t.framebufferTexture2D(t.FRAMEBUFFER,J,Y,ue,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function ee(A){const _=i.get(A),O=A.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==A.depthTexture){const H=A.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),H){const X=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,H.removeEventListener("dispose",X)};H.addEventListener("dispose",X),_.__depthDisposeCallback=X}_.__boundDepthTexture=H}if(A.depthTexture&&!_.__autoAllocateDepthBuffer)if(O)for(let H=0;H<6;H++)Ye(_.__webglFramebuffer[H],A,H);else{const H=A.texture.mipmaps;H&&H.length>0?Ye(_.__webglFramebuffer[0],A,0):Ye(_.__webglFramebuffer,A,0)}else if(O){_.__webglDepthbuffer=[];for(let H=0;H<6;H++)if(n.bindFramebuffer(t.FRAMEBUFFER,_.__webglFramebuffer[H]),_.__webglDepthbuffer[H]===void 0)_.__webglDepthbuffer[H]=t.createRenderbuffer(),mt(_.__webglDepthbuffer[H],A,!1);else{const X=A.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ue=_.__webglDepthbuffer[H];t.bindRenderbuffer(t.RENDERBUFFER,ue),t.framebufferRenderbuffer(t.FRAMEBUFFER,X,t.RENDERBUFFER,ue)}}else{const H=A.texture.mipmaps;if(H&&H.length>0?n.bindFramebuffer(t.FRAMEBUFFER,_.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=t.createRenderbuffer(),mt(_.__webglDepthbuffer,A,!1);else{const X=A.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ue=_.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,ue),t.framebufferRenderbuffer(t.FRAMEBUFFER,X,t.RENDERBUFFER,ue)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function re(A,_,O){const H=i.get(A);_!==void 0&&Be(H.__webglFramebuffer,A,A.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),O!==void 0&&ee(A)}function ie(A){const _=A.texture,O=i.get(A),H=i.get(_);A.addEventListener("dispose",v);const X=A.textures,ue=A.isWebGLCubeRenderTarget===!0,de=X.length>1;if(de||(H.__webglTexture===void 0&&(H.__webglTexture=t.createTexture()),H.__version=_.version,a.memory.textures++),ue){O.__webglFramebuffer=[];for(let Y=0;Y<6;Y++)if(_.mipmaps&&_.mipmaps.length>0){O.__webglFramebuffer[Y]=[];for(let J=0;J<_.mipmaps.length;J++)O.__webglFramebuffer[Y][J]=t.createFramebuffer()}else O.__webglFramebuffer[Y]=t.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){O.__webglFramebuffer=[];for(let Y=0;Y<_.mipmaps.length;Y++)O.__webglFramebuffer[Y]=t.createFramebuffer()}else O.__webglFramebuffer=t.createFramebuffer();if(de)for(let Y=0,J=X.length;Y<J;Y++){const pe=i.get(X[Y]);pe.__webglTexture===void 0&&(pe.__webglTexture=t.createTexture(),a.memory.textures++)}if(A.samples>0&&$e(A)===!1){O.__webglMultisampledFramebuffer=t.createFramebuffer(),O.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let Y=0;Y<X.length;Y++){const J=X[Y];O.__webglColorRenderbuffer[Y]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,O.__webglColorRenderbuffer[Y]);const pe=s.convert(J.format,J.colorSpace),Ie=s.convert(J.type),ve=y(J.internalFormat,pe,Ie,J.normalized,J.colorSpace,A.isXRRenderTarget===!0),me=Xe(A);t.renderbufferStorageMultisample(t.RENDERBUFFER,me,ve,A.width,A.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Y,t.RENDERBUFFER,O.__webglColorRenderbuffer[Y])}t.bindRenderbuffer(t.RENDERBUFFER,null),A.depthBuffer&&(O.__webglDepthRenderbuffer=t.createRenderbuffer(),mt(O.__webglDepthRenderbuffer,A,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ue){n.bindTexture(t.TEXTURE_CUBE_MAP,H.__webglTexture),it(t.TEXTURE_CUBE_MAP,_);for(let Y=0;Y<6;Y++)if(_.mipmaps&&_.mipmaps.length>0)for(let J=0;J<_.mipmaps.length;J++)Be(O.__webglFramebuffer[Y][J],A,_,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Y,J);else Be(O.__webglFramebuffer[Y],A,_,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0);d(_)&&x(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(de){for(let Y=0,J=X.length;Y<J;Y++){const pe=X[Y],Ie=i.get(pe);let ve=t.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ve=A.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ve,Ie.__webglTexture),it(ve,pe),Be(O.__webglFramebuffer,A,pe,t.COLOR_ATTACHMENT0+Y,ve,0),d(pe)&&x(ve)}n.unbindTexture()}else{let Y=t.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(Y=A.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(Y,H.__webglTexture),it(Y,_),_.mipmaps&&_.mipmaps.length>0)for(let J=0;J<_.mipmaps.length;J++)Be(O.__webglFramebuffer[J],A,_,t.COLOR_ATTACHMENT0,Y,J);else Be(O.__webglFramebuffer,A,_,t.COLOR_ATTACHMENT0,Y,0);d(_)&&x(Y),n.unbindTexture()}A.depthBuffer&&ee(A)}function ye(A){const _=A.textures;for(let O=0,H=_.length;O<H;O++){const X=_[O];if(d(X)){const ue=S(A),de=i.get(X).__webglTexture;n.bindTexture(ue,de),x(ue),n.unbindTexture()}}}const _e=[],ze=[];function De(A){if(A.samples>0){if($e(A)===!1){const _=A.textures,O=A.width,H=A.height;let X=t.COLOR_BUFFER_BIT;const ue=A.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,de=i.get(A),Y=_.length>1;if(Y)for(let pe=0;pe<_.length;pe++)n.bindFramebuffer(t.FRAMEBUFFER,de.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+pe,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,de.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+pe,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,de.__webglMultisampledFramebuffer);const J=A.texture.mipmaps;J&&J.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,de.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,de.__webglFramebuffer);for(let pe=0;pe<_.length;pe++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(X|=t.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(X|=t.STENCIL_BUFFER_BIT)),Y){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,de.__webglColorRenderbuffer[pe]);const Ie=i.get(_[pe]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Ie,0)}t.blitFramebuffer(0,0,O,H,0,0,O,H,X,t.NEAREST),l===!0&&(_e.length=0,ze.length=0,_e.push(t.COLOR_ATTACHMENT0+pe),A.depthBuffer&&A.resolveDepthBuffer===!1&&(_e.push(ue),ze.push(ue),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,ze)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,_e))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),Y)for(let pe=0;pe<_.length;pe++){n.bindFramebuffer(t.FRAMEBUFFER,de.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+pe,t.RENDERBUFFER,de.__webglColorRenderbuffer[pe]);const Ie=i.get(_[pe]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,de.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+pe,t.TEXTURE_2D,Ie,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,de.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const _=A.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[_])}}}function Xe(A){return Math.min(r.maxSamples,A.samples)}function $e(A){const _=i.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function L(A){const _=a.render.frame;f.get(A)!==_&&(f.set(A,_),A.update())}function vt(A,_){const O=A.colorSpace,H=A.format,X=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||O!==ku&&O!==_r&&(ut.getTransfer(O)===gt?(H!==oi||X!==In)&&Ve("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ct("WebGLTextures: Unsupported texture color space:",O)),_}function st(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(u.width=A.naturalWidth||A.width,u.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(u.width=A.displayWidth,u.height=A.displayHeight):(u.width=A.width,u.height=A.height),u}this.allocateTextureUnit=Z,this.resetTextureUnits=$,this.getTextureUnits=Q,this.setTextureUnits=F,this.setTexture2D=U,this.setTexture2DArray=W,this.setTexture3D=j,this.setTextureCube=ne,this.rebindTextures=re,this.setupRenderTarget=ie,this.updateRenderTargetMipmap=ye,this.updateMultisampleRenderTarget=De,this.setupDepthRenderbuffer=ee,this.setupFrameBufferTexture=Be,this.useMultisampledRTT=$e,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function LR(t,e){function n(i,r=_r){let s;const a=ut.getTransfer(r);if(i===In)return t.UNSIGNED_BYTE;if(i===Mp)return t.UNSIGNED_SHORT_4_4_4_4;if(i===Ep)return t.UNSIGNED_SHORT_5_5_5_1;if(i===Mx)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===Ex)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===yx)return t.BYTE;if(i===Sx)return t.SHORT;if(i===Lo)return t.UNSIGNED_SHORT;if(i===Sp)return t.INT;if(i===Ri)return t.UNSIGNED_INT;if(i===Si)return t.FLOAT;if(i===ji)return t.HALF_FLOAT;if(i===Tx)return t.ALPHA;if(i===wx)return t.RGB;if(i===oi)return t.RGBA;if(i===Ji)return t.DEPTH_COMPONENT;if(i===ts)return t.DEPTH_STENCIL;if(i===Ax)return t.RED;if(i===Tp)return t.RED_INTEGER;if(i===fs)return t.RG;if(i===wp)return t.RG_INTEGER;if(i===Ap)return t.RGBA_INTEGER;if(i===nu||i===iu||i===ru||i===su)if(a===gt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===nu)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===iu)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ru)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===su)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===nu)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===iu)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ru)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===su)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===zd||i===Vd||i===Hd||i===Gd)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===zd)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Vd)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Hd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Gd)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Wd||i===Xd||i===Yd||i===Zd||i===$d||i===Ou||i===qd)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Wd||i===Xd)return a===gt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Yd)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Zd)return s.COMPRESSED_R11_EAC;if(i===$d)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Ou)return s.COMPRESSED_RG11_EAC;if(i===qd)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Kd||i===jd||i===Jd||i===Qd||i===eh||i===th||i===nh||i===ih||i===rh||i===sh||i===ah||i===oh||i===lh||i===uh)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Kd)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===jd)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Jd)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Qd)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===eh)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===th)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===nh)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===ih)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===rh)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===sh)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===ah)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===oh)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===lh)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===uh)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===ch||i===fh||i===dh)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===ch)return a===gt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===fh)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===dh)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===hh||i===ph||i===Fu||i===mh)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===hh)return s.COMPRESSED_RED_RGTC1_EXT;if(i===ph)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Fu)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===mh)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===No?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const NR=`
void main() {
