...
`)}const GC={[dx]:"Linear",[hx]:"Reinhard",[px]:"Cineon",[mx]:"ACESFilmic",[_x]:"AgX",[vx]:"Neutral",[gx]:"Custom"};function WC(t,e){const n=GC[e];return n===void 0?(He("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+t+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const zl=new N;function XC(){ut.getLuminanceCoefficients(zl);const t=zl.x.toFixed(4),e=zl.y.toFixed(4),n=zl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+d);const S=x+g+a,y=x+d+o,w=A_(r,r.VERTEX_SHADER,S),T=A_(r,r.FRAGMENT_SHADER,y);r.attachShader(M,w),r.attachShader(M,T),n.index0AttributeName!==void 0?r.bindAttribLocation(M,0,n.index0AttributeName):n.hasPositionAttribute===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function b(P){if(t.debug.checkShaderErrors){const k=r.getProgramInfoLog(M)||"",$=r.getShaderInfoLog(w)||"",Q=r.getShaderInfoLog(T)||"",F=k.trim(),Z=$.trim(),B=Q.trim();let U=!0,W=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(U=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,M,w,T);else{const j=C_(r,w,"vertex"),ne=C_(r,T,"fragment");ct("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
}`,AR=[new N(1,0,0),new N(-1,0,0),new N(0,1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1)],bR=[new N(0,-1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1),new N(0,-1,0),new N(0,-1,0)],O_=new Pt,Wa=new N,bf=new N;function CR(t,e,n){let i=new Lp;const r=new ce,s=new ce,a=new Nt,o=new F1,l=new k1,u={},f=n.maxTextureSize,h={[Or]:Rn,[Rn]:Or,[Si]:Si},c=new Ni({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ce},radius:{value:4}},vertexShader:TR,fragmentShader:wR}),p=c.clone();p.defines.HORIZONTAL_PASS=1;const m=new Vn;m.setAttribute("position",new Ri(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new Li(m,c),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=tu;let d=this.type;this.render=function(T,b,_){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||T.length===0)return;this.type===WE&&(He("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=tu);const C=t.getRenderTarget(),R=t.getActiveCubeFace(),P=t.getActiveMipmapLevel(),k=t.state;k.setBlending(Xi),k.buffers.depth.getReversed()===!0?k.buffers.color.setClear(0,0,0,0):k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const $=d!==this.type;$&&b.traverse(function(Q){Q.material&&(Array.isArray(Q.material)?Q.material.forEach(F=>F.needsUpdate=!0):Q.material.needsUpdate=!0)});for(let Q=0,F=T.length;Q<F;Q++){const Z=T[Q],B=Z.shadow;if(B===void 0){He("WebGLShadowMap:",Z,"has no shadow.");continue}if(B.autoUpdate===!1&&B.needsUpdate===!1)continue;r.copy(B.mapSize);const U=B.getFrameExtents();r.multiply(U),s.copy(B.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/U.x),r.x=s.x*U.x,B.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/U.y),r.y=s.y*U.y,B.mapSize.y=s.y));const W=t.state.buffers.depth.getReversed();if(B.camera._reversedDepth=W,B.map===null||$===!0){if(B.map!==null&&(B.map.depthTexture!==null&&(B.map.depthTexture.dispose(),B.map.depthTexture=null),B.map.dispose()),this.type===Ka){if(Z.isPointLight){He("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}B.map=new Ci(r.x,r.y,{format:ds,type:Ji,minFilter:hn,magFilter:hn,generateMipmaps:!1}),B.map.texture.name=Z.name+".shadowMap",B.map.depthTexture=new ya(r.x,r.y,Mi),B.map.depthTexture.name=Z.name+".shadowMapDepth",B.map.depthTexture.format=Qi,B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=tn,B.map.depthTexture.magFilter=tn}else Z.isPointLight?(B.map=new jx(r.x),B.map.depthTexture=new KT(r.x,Pi)):(B.map=new Ci(r.x,r.y),B.map.depthTexture=new ya(r.x,r.y,Pi)),B.map.depthTexture.name=Z.name+".shadowMap",B.map.depthTexture.format=Qi,this.type===tu?(B.map.depthTexture.compareFunction=W?Cp:bp,B.map.depthTexture.minFilter=hn,B.map.depthTexture.magFilter=hn):(B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=tn,B.map.depthTexture.magFilter=tn);B.camera.updateProjectionMatrix()}const j=B.map.isWebGLCubeRenderTarget?6:1;for(let ne=0;ne<j;ne++){if(B.map.isWebGLCubeRenderTarget)t.setRenderTarget(B.map,ne),t.clear();else{ne===0&&(t.setRenderTarget(B.map),t.clear());const le=B.getViewport(ne);a.set(s.x*le.x,s.y*le.y,s.x*le.z,s.y*le.w),k.viewport(a)}if(Z.isPointLight){const le=B.camera,Ze=B.matrix,lt=Z.distance||le.far;lt!==le.far&&(le.far=lt,le.updateProjectionMatrix()),Wa.setFromMatrixPosition(Z.matrixWorld),le.position.copy(Wa),bf.copy(le.position),bf.add(AR[ne]),le.up.copy(bR[ne]),le.lookAt(bf),le.updateMatrixWorld(),Ze.makeTranslation(-Wa.x,-Wa.y,-Wa.z),O_.multiplyMatrices(le.projectionMatrix,le.matrixWorldInverse),B._frustum.setFromProjectionMatrix(O_,le.coordinateSystem,le.reversedDepth)}else B.updateMatrices(Z);i=B.getFrustum(),y(b,_,B.camera,Z,this.type)}B.isPointLightShadow!==!0&&this.type===Ka&&x(B,_),B.needsUpdate=!1}d=this.type,g.needsUpdate=!1,t.setRenderTarget(C,R,P)};function x(T,b){const _=e.update(M);c.defines.VSM_SAMPLES!==T.blurSamples&&(c.defines.VSM_SAMPLES=T.blurSamples,p.defines.VSM_SAMPLES=T.blurSamples,c.needsUpdate=!0,p.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new Ci(r.x,r.y,{format:ds,type:Ji})),c.uniforms.shadow_pass.value=T.map.depthTexture,c.uniforms.resolution.value=T.mapSize,c.uniforms.radius.value=T.radius,t.setRenderTarget(T.mapPass),t.clear(),t.renderBufferDirect(b,null,_,c,M,null),p.uniforms.shadow_pass.value=T.mapPass.texture,p.uniforms.resolution.value=T.mapSize,p.uniforms.radius.value=T.radius,t.setRenderTarget(T.map),t.clear(),t.renderBufferDirect(b,null,_,p,M,null)}function S(T,b,_,C){let R=null;const P=_.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(P!==void 0)R=P;else if(R=_.isPointLight===!0?l:o,t.localClippingEnabled&&b.clipShadows===!0&&Array.isArray(b.clippingPlanes)&&b.clippingPlanes.length!==0||b.displacementMap&&b.displacementScale!==0||b.alphaMap&&b.alphaTest>0||b.map&&b.alphaTest>0||b.alphaToCoverage===!0){const k=R.uuid,$=b.uuid;let Q=u[k];Q===void 0&&(Q={},u[k]=Q);let F=Q[$];F===void 0&&(F=R.clone(),Q[$]=F,b.addEventListener("dispose",w)),R=F}if(R.visible=b.visible,R.wireframe=b.wireframe,C===Ka?R.side=b.shadowSide!==null?b.shadowSide:b.side:R.side=b.shadowSide!==null?b.shadowSide:h[b.side],R.alphaMap=b.alphaMap,R.alphaTest=b.alphaToCoverage===!0?.5:b.alphaTest,R.map=b.map,R.clipShadows=b.clipShadows,R.clippingPlanes=b.clippingPlanes,R.clipIntersection=b.clipIntersection,R.displacementMap=b.displacementMap,R.displacementScale=b.displacementScale,R.displacementBias=b.displacementBias,R.wireframeLinewidth=b.wireframeLinewidth,R.linewidth=b.linewidth,_.isPointLight===!0&&R.isMeshDistanceMaterial===!0){const k=t.properties.get(R);k.light=_}return R}function y(T,b,_,C,R){if(T.visible===!1)return;if(T.layers.test(b.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&R===Ka)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,T.matrixWorld);const $=e.update(T),Q=T.material;if(Array.isArray(Q)){const F=$.groups;for(let Z=0,B=F.length;Z<B;Z++){const U=F[Z],W=Q[U.materialIndex];if(W&&W.visible){const j=S(T,W,C,R);T.onBeforeShadow(t,T,b,_,$,j,U),t.renderBufferDirect(_,null,$,j,T,U),T.onAfterShadow(t,T,b,_,$,j,U)}}}else if(Q.visible){const F=S(T,Q,C,R);T.onBeforeShadow(t,T,b,_,$,F,null),t.renderBufferDirect(_,null,$,F,T,null),T.onAfterShadow(t,T,b,_,$,F,null)}}const k=T.children;for(let $=0,Q=k.length;$<Q;$++)y(k[$],b,_,C,R)}function w(T){T.target.removeEventListener("dispose",w);for(const _ in u){const C=u[_],R=T.target.uuid;R in C&&(C[R].dispose(),delete C[R])}}}function RR(t,e){function n(){let D=!1;const he=new Nt;let K=null;const ge=new Nt(0,0,0,0);return{setMask:function(Ee){K!==Ee&&!D&&(t.colorMask(Ee,Ee,Ee,Ee),K=Ee)},setLocked:function(Ee){D=Ee},setClear:function(Ee,te,Ne,Re,Ot){Ot===!0&&(Ee*=Re,te*=Re,Ne*=Re),he.set(Ee,te,Ne,Re),ge.equals(he)===!1&&(t.clearColor(Ee,te,Ne,Re),ge.copy(he))},reset:function(){D=!1,K=null,ge.set(-1,0,0,0)}}}function i(){let D=!1,he=!1,K=null,ge=null,Ee=null;return{setReversed:function(te){if(he!==te){const Ne=e.get("EXT_clip_control");te?Ne.clipControlEXT(Ne.LOWER_LEFT_EXT,Ne.ZERO_TO_ONE_EXT):Ne.clipControlEXT(Ne.LOWER_LEFT_EXT,Ne.NEGATIVE_ONE_TO_ONE_EXT),he=te;const Re=Ee;Ee=null,this.setClear(Re)}},getReversed:function(){return he},setTest:function(te){te?se(t.DEPTH_TEST):Oe(t.DEPTH_TEST)},setMask:function(te){K!==te&&!D&&(t.depthMask(te),K=te)},setFunc:function(te){if(he&&(te=ET[te]),ge!==te){switch(te){case Ld:t.depthFunc(t.NEVER);break;case Nd:t.depthFunc(t.ALWAYS);break;case Dd:t.depthFunc(t.LESS);break;case va:t.depthFunc(t.LEQUAL);break;case Id:t.depthFunc(t.EQUAL);break;case Ud:t.depthFunc(t.GEQUAL);break;case Od:t.depthFunc(t.GREATER);break;case Fd:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ge=te}},setLocked:function(te){D=te},setClear:function(te){Ee!==te&&(Ee=te,he&&(te=1-te),t.clearDepth(te))},reset:function(){D=!1,K=null,ge=null,Ee=null,he=!1}}}function r(){let D=!1,he=null,K=null,ge=null,Ee=null,te=null,Ne=null,Re=null,Ot=null;return{setTest:function(Et){D||(Et?se(t.STENCIL_TEST):Oe(t.STENCIL_TEST))},setMask:function(Et){he!==Et&&!D&&(t.stencilMask(Et),he=Et)},setFunc:function(Et,fi,di){(K!==Et||ge!==fi||Ee!==di)&&(t.stencilFunc(Et,fi,di),K=Et,ge=fi,Ee=di)},setOp:function(Et,fi,di){(te!==Et||Ne!==fi||Re!==di)&&(t.stencilOp(Et,fi,di),te=Et,Ne=fi,Re=di)},setLocked:function(Et){D=Et},setClear:function(Et){Ot!==Et&&(t.clearStencil(Et),Ot=Et)},reset:function(){D=!1,he=null,K=null,ge=null,Ee=null,te=null,Ne=null,Re=null,Ot=null}}}const s=new n,a=new i,o=new r,l=new WeakMap,u=new WeakMap;let f={},h={},c={},p=new WeakMap,m=[],M=null,g=!1,d=null,x=null,S=null,y=null,w=null,T=null,b=null,_=new at(0,0,0),C=0,R=!1,P=null,k=null,$=null,Q=null,F=null;const Z=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,U=0;const W=t.getParameter(t.VERSION);W.indexOf("WebGL")!==-1?(U=parseFloat(/^WebGL (\d)/.exec(W)[1]),B=U>=1):W.indexOf("OpenGL ES")!==-1&&(U=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),B=U>=2);let j=null,ne={};const le=t.getParameter(t.SCISSOR_BOX),Ze=t.getParameter(t.VIEWPORT),lt=new Nt().fromArray(le),it=new Nt().fromArray(Ze);function q(D,he,K,ge){const Ee=new Uint8Array(4),te=t.createTexture();t.bindTexture(D,te),t.texParameteri(D,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(D,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Ne=0;Ne<K;Ne++)D===t.TEXTURE_3D||D===t.TEXTURE_2D_ARRAY?t.texImage3D(he,0,t.RGBA,1,1,ge,0,t.RGBA,t.UNSIGNED_BYTE,Ee):t.texImage2D(he+Ne,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,Ee);return te}const fe={};fe[t.TEXTURE_2D]=q(t.TEXTURE_2D,t.TEXTURE_2D,1),fe[t.TEXTURE_CUBE_MAP]=q(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),fe[t.TEXTURE_2D_ARRAY]=q(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),fe[t.TEXTURE_3D]=q(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),se(t.DEPTH_TEST),a.setFunc(va),ye(!1),_e(Ag),se(t.CULL_FACE),re(Xi);function se(D){f[D]!==!0&&(t.enable(D),f[D]=!0)}function Oe(D){f[D]!==!1&&(t.disable(D),f[D]=!1)}function We(D,he){return c[D]!==he?(t.bindFramebuffer(D,he),c[D]=he,D===t.DRAW_FRAMEBUFFER&&(c[t.FRAMEBUFFER]=he),D===t.FRAMEBUFFER&&(c[t.DRAW_FRAMEBUFFER]=he),!0):!1}function Be(D,he){let K=m,ge=!1;if(D){K=p.get(he),K===void 0&&(K=[],p.set(he,K));const Ee=D.textures;if(K.length!==Ee.length||K[0]!==t.COLOR_ATTACHMENT0){for(let te=0,Ne=Ee.length;te<Ne;te++)K[te]=t.COLOR_ATTACHMENT0+te;K.length=Ee.length,ge=!0}}else K[0]!==t.BACK&&(K[0]=t.BACK,ge=!0);ge&&t.drawBuffers(K)}function mt(D){return M!==D?(t.useProgram(D),M=D,!0):!1}const Ye={[Kr]:t.FUNC_ADD,[YE]:t.FUNC_SUBTRACT,[ZE]:t.FUNC_REVERSE_SUBTRACT};Ye[$E]=t.MIN,Ye[qE]=t.MAX;const ee={[KE]:t.ZERO,[jE]:t.ONE,[JE]:t.SRC_COLOR,[Rd]:t.SRC_ALPHA,[rT]:t.SRC_ALPHA_SATURATE,[nT]:t.DST_COLOR,[eT]:t.DST_ALPHA,[QE]:t.ONE_MINUS_SRC_COLOR,[Pd]:t.ONE_MINUS_SRC_ALPHA,[iT]:t.ONE_MINUS_DST_COLOR,[tT]:t.ONE_MINUS_DST_ALPHA,[sT]:t.CONSTANT_COLOR,[aT]:t.ONE_MINUS_CONSTANT_COLOR,[oT]:t.CONSTANT_ALPHA,[lT]:t.ONE_MINUS_CONSTANT_ALPHA};function re(D,he,K,ge,Ee,te,Ne,Re,Ot,Et){if(D===Xi){g===!0&&(Oe(t.BLEND),g=!1);return}if(g===!1&&(se(t.BLEND),g=!0),D!==XE){if(D!==d||Et!==R){if((x!==Kr||w!==Kr)&&(t.blendEquation(t.FUNC_ADD),x=Kr,w=Kr),Et)switch(D){case ia:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case bg:t.blendFunc(t.ONE,t.ONE);break;case Cg:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Rg:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:ct("WebGLState: Invalid blending: ",D);break}else switch(D){case ia:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case bg:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case Cg:ct("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Rg:ct("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ct("WebGLState: Invalid blending: ",D);break}S=null,y=null,T=null,b=null,_.set(0,0,0),C=0,d=D,R=Et}return}Ee=Ee||he,te=te||K,Ne=Ne||ge,(he!==x||Ee!==w)&&(t.blendEquationSeparate(Ye[he],Ye[Ee]),x=he,w=Ee),(K!==S||ge!==y||te!==T||Ne!==b)&&(t.blendFuncSeparate(ee[K],ee[ge],ee[te],ee[Ne]),S=K,y=ge,T=te,b=Ne),(Re.equals(_)===!1||Ot!==C)&&(t.blendColor(Re.r,Re.g,Re.b,Ot),_.copy(Re),C=Ot),d=D,R=!1}function ie(D,he){D.side===Si?Oe(t.CULL_FACE):se(t.CULL_FACE);let K=D.side===Rn;he&&(K=!K),ye(K),D.blending===ia&&D.transparent===!1?re(Xi):re(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),s.setMask(D.colorWrite);const ge=D.stencilWrite;o.setTest(ge),ge&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),De(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?se(t.SAMPLE_ALPHA_TO_COVERAGE):Oe(t.SAMPLE_ALPHA_TO_COVERAGE)}function ye(D){P!==D&&(D?t.frontFace(t.CW):t.frontFace(t.CCW),P=D)}function _e(D){D!==HE?(se(t.CULL_FACE),D!==k&&(D===Ag?t.cullFace(t.BACK):D===GE?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Oe(t.CULL_FACE),k=D}function ze(D){D!==$&&(B&&t.lineWidth(D),$=D)}function De(D,he,K){D?(se(t.POLYGON_OFFSET_FILL),(Q!==he||F!==K)&&(Q=he,F=K,a.getReversed()&&(he=-he),t.polygonOffset(he,K))):Oe(t.POLYGON_OFFSET_FILL)}function Xe(D){D?se(t.SCISSOR_TEST):Oe(t.SCISSOR_TEST)}function $e(D){D===void 0&&(D=t.TEXTURE0+Z-1),j!==D&&(t.activeTexture(D),j=D)}function L(D,he,K){K===void 0&&(j===null?K=t.TEXTURE0+Z-1:K=j);let ge=ne[K];ge===void 0&&(ge={type:void 0,texture:void 0},ne[K]=ge),(ge.type!==D||ge.texture!==he)&&(j!==K&&(t.activeTexture(K),j=K),t.bindTexture(D,he||fe[D]),ge.type=D,ge.texture=he)}function vt(){const D=ne[j];D!==void 0&&D.type!==void 0&&(t.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function st(){try{t.compressedTexImage2D(...arguments)}catch(D){ct("WebGLState:",D)}}function A(){try{t.compressedTexImage3D(...arguments)}catch(D){ct("WebGLState:",D)}}function v(){try{t.texSubImage2D(...arguments)}catch(D){ct("WebGLState:",D)}}function O(){try{t.texSubImage3D(...arguments)}catch(D){ct("WebGLState:",D)}}function H(){try{t.compressedTexSubImage2D(...arguments)}catch(D){ct("WebGLState:",D)}}function X(){try{t.compressedTexSubImage3D(...arguments)}catch(D){ct("WebGLState:",D)}}function ue(){try{t.texStorage2D(...arguments)}catch(D){ct("WebGLState:",D)}}function de(){try{t.texStorage3D(...arguments)}catch(D){ct("WebGLState:",D)}}function Y(){try{t.texImage2D(...arguments)}catch(D){ct("WebGLState:",D)}}function J(){try{t.texImage3D(...arguments)}catch(D){ct("WebGLState:",D)}}function pe(D){return h[D]!==void 0?h[D]:t.getParameter(D)}function Ie(D,he){h[D]!==he&&(t.pixelStorei(D,he),h[D]=he)}function ve(D){lt.equals(D)===!1&&(t.scissor(D.x,D.y,D.z,D.w),lt.copy(D))}function me(D){it.equals(D)===!1&&(t.viewport(D.x,D.y,D.z,D.w),it.copy(D))}function ke(D,he){let K=u.get(he);K===void 0&&(K=new WeakMap,u.set(he,K));let ge=K.get(D);ge===void 0&&(ge=t.getUniformBlockIndex(he,D.name),K.set(D,ge))}function Ge(D,he){const ge=u.get(he).get(D);l.get(he)!==ge&&(t.uniformBlockBinding(he,ge,D.__bindingPointIndex),l.set(he,ge))}function Je(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),a.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),f={},h={},j=null,ne={},c={},p=new WeakMap,m=[],M=null,g=!1,d=null,x=null,S=null,y=null,w=null,T=null,b=null,_=new at(0,0,0),C=0,R=!1,P=null,k=null,$=null,Q=null,F=null,lt.set(0,0,t.canvas.width,t.canvas.height),it.set(0,0,t.canvas.width,t.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:se,disable:Oe,bindFramebuffer:We,drawBuffers:Be,useProgram:mt,setBlending:re,setMaterial:ie,setFlipSided:ye,setCullFace:_e,setLineWidth:ze,setPolygonOffset:De,setScissorTest:Xe,activeTexture:$e,bindTexture:L,unbindTexture:vt,compressedTexImage2D:st,compressedTexImage3D:A,texImage2D:Y,texImage3D:J,pixelStorei:Ie,getParameter:pe,updateUBOMapping:ke,uniformBlockBinding:Ge,texStorage2D:ue,texStorage3D:de,texSubImage2D:v,texSubImage3D:O,compressedTexSubImage2D:H,compressedTexSubImage3D:X,scissor:ve,viewport:me,reset:Je}}function PR(t,e,n,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new ce,f=new WeakMap,h=new Set;let c;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(A,v){return m?new OffscreenCanvas(A,v):zu("canvas")}function g(A,v,O){let H=1;const X=st(A);if((X.width>O||X.height>O)&&(H=O/Math.max(X.width,X.height)),H<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const ue=Math.floor(H*X.width),de=Math.floor(H*X.height);c===void 0&&(c=M(ue,de));const Y=v?M(ue,de):c;return Y.width=ue,Y.height=de,Y.getContext("2d").drawImage(A,0,0,ue,de),He("WebGLRenderer: Texture has been resized from ("+X.width+"x"+X.height+") to ("+ue+"x"+de+")."),Y}else return"data"in A&&He("WebGLRenderer: Image in DataTexture is too big ("+X.width+"x"+X.height+")."),A;return A}function d(A){return A.generateMipmaps}function x(A){t.generateMipmap(A)}function S(A){return A.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?t.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function y(A,v,O,H,X,ue=!1){if(A!==null){if(t[A]!==void 0)return t[A];He("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let de;H&&(de=e.get("EXT_texture_norm16"),de||He("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Y=v;if(v===t.RED&&(O===t.FLOAT&&(Y=t.R32F),O===t.HALF_FLOAT&&(Y=t.R16F),O===t.UNSIGNED_BYTE&&(Y=t.R8),O===t.UNSIGNED_SHORT&&de&&(Y=de.R16_EXT),O===t.SHORT&&de&&(Y=de.R16_SNORM_EXT)),v===t.RED_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.R8UI),O===t.UNSIGNED_SHORT&&(Y=t.R16UI),O===t.UNSIGNED_INT&&(Y=t.R32UI),O===t.BYTE&&(Y=t.R8I),O===t.SHORT&&(Y=t.R16I),O===t.INT&&(Y=t.R32I)),v===t.RG&&(O===t.FLOAT&&(Y=t.RG32F),O===t.HALF_FLOAT&&(Y=t.RG16F),O===t.UNSIGNED_BYTE&&(Y=t.RG8),O===t.UNSIGNED_SHORT&&de&&(Y=de.RG16_EXT),O===t.SHORT&&de&&(Y=de.RG16_SNORM_EXT)),v===t.RG_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RG8UI),O===t.UNSIGNED_SHORT&&(Y=t.RG16UI),O===t.UNSIGNED_INT&&(Y=t.RG32UI),O===t.BYTE&&(Y=t.RG8I),O===t.SHORT&&(Y=t.RG16I),O===t.INT&&(Y=t.RG32I)),v===t.RGB_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RGB8UI),O===t.UNSIGNED_SHORT&&(Y=t.RGB16UI),O===t.UNSIGNED_INT&&(Y=t.RGB32UI),O===t.BYTE&&(Y=t.RGB8I),O===t.SHORT&&(Y=t.RGB16I),O===t.INT&&(Y=t.RGB32I)),v===t.RGBA_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RGBA8UI),O===t.UNSIGNED_SHORT&&(Y=t.RGBA16UI),O===t.UNSIGNED_INT&&(Y=t.RGBA32UI),O===t.BYTE&&(Y=t.RGBA8I),O===t.SHORT&&(Y=t.RGBA16I),O===t.INT&&(Y=t.RGBA32I)),v===t.RGB&&(O===t.UNSIGNED_SHORT&&de&&(Y=de.RGB16_EXT),O===t.SHORT&&de&&(Y=de.RGB16_SNORM_EXT),O===t.UNSIGNED_INT_5_9_9_9_REV&&(Y=t.RGB9_E5),O===t.UNSIGNED_INT_10F_11F_11F_REV&&(Y=t.R11F_G11F_B10F)),v===t.RGBA){const J=ue?Bu:ut.getTransfer(X);O===t.FLOAT&&(Y=t.RGBA32F),O===t.HALF_FLOAT&&(Y=t.RGBA16F),O===t.UNSIGNED_BYTE&&(Y=J===gt?t.SRGB8_ALPHA8:t.RGBA8),O===t.UNSIGNED_SHORT&&de&&(Y=de.RGBA16_EXT),O===t.SHORT&&de&&(Y=de.RGBA16_SNORM_EXT),O===t.UNSIGNED_SHORT_4_4_4_4&&(Y=t.RGBA4),O===t.UNSIGNED_SHORT_5_5_5_1&&(Y=t.RGB5_A1)}return(Y===t.R16F||Y===t.R32F||Y===t.RG16F||Y===t.RG32F||Y===t.RGBA16F||Y===t.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function w(A,v){let O;return A?v===null||v===Pi||v===No?O=t.DEPTH24_STENCIL8:v===Mi?O=t.DEPTH32F_STENCIL8:v===Lo&&(O=t.DEPTH24_STENCIL8,He("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Pi||v===No?O=t.DEPTH_COMPONENT24:v===Mi?O=t.DEPTH_COMPONENT32F:v===Lo&&(O=t.DEPTH_COMPONENT16),O}function T(A,v){return d(A)===!0||A.isFramebufferTexture&&A.minFilter!==tn&&A.minFilter!==hn?Math.log2(Math.max(v.width,v.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?v.mipmaps.length:1}function b(A){const v=A.target;v.removeEventListener("dispose",b),C(v),v.isVideoTexture&&f.delete(v),v.isHTMLTexture&&h.delete(v)}function _(A){const v=A.target;v.removeEventListener("dispose",_),P(v)}function C(A){const v=i.get(A);if(v.__webglInit===void 0)return;const O=A.source,H=p.get(O);if(H){const X=H[v.__cacheKey];X.usedTimes--,X.usedTimes===0&&R(A),Object.keys(H).length===0&&p.delete(O)}i.remove(A)}function R(A){const v=i.get(A);t.deleteTexture(v.__webglTexture);const O=A.source,H=p.get(O);delete H[v.__cacheKey],a.memory.textures--}function P(A){const v=i.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),i.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let H=0;H<6;H++){if(Array.isArray(v.__webglFramebuffer[H]))for(let X=0;X<v.__webglFramebuffer[H].length;X++)t.deleteFramebuffer(v.__webglFramebuffer[H][X]);else t.deleteFramebuffer(v.__webglFramebuffer[H]);v.__webglDepthbuffer&&t.deleteRenderbuffer(v.__webglDepthbuffer[H])}else{if(Array.isArray(v.__webglFramebuffer))for(let H=0;H<v.__webglFramebuffer.length;H++)t.deleteFramebuffer(v.__webglFramebuffer[H]);else t.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&t.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&t.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let H=0;H<v.__webglColorRenderbuffer.length;H++)v.__webglColorRenderbuffer[H]&&t.deleteRenderbuffer(v.__webglColorRenderbuffer[H]);v.__webglDepthRenderbuffer&&t.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const O=A.textures;for(let H=0,X=O.length;H<X;H++){const ue=i.get(O[H]);ue.__webglTexture&&(t.deleteTexture(ue.__webglTexture),a.memory.textures--),i.remove(O[H])}i.remove(A)}let k=0;function $(){k=0}function Q(){return k}function F(A){k=A}function Z(){const A=k;return A>=r.maxTextures&&He("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+r.maxTextures),k+=1,A}function B(A){const v=[];return v.push(A.wrapS),v.push(A.wrapT),v.push(A.wrapR||0),v.push(A.magFilter),v.push(A.minFilter),v.push(A.anisotropy),v.push(A.internalFormat),v.push(A.format),v.push(A.type),v.push(A.generateMipmaps),v.push(A.premultiplyAlpha),v.push(A.flipY),v.push(A.unpackAlignment),v.push(A.colorSpace),v.join()}function U(A,v){const O=i.get(A);if(A.isVideoTexture&&L(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&O.__version!==A.version){const H=A.image;if(H===null)He("WebGLRenderer: Texture marked for update but no image data found.");else if(H.complete===!1)He("WebGLRenderer: Texture marked for update but image is incomplete");else{Oe(O,A,v);return}}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,O.__webglTexture,t.TEXTURE0+v)}function W(A,v){const O=i.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){Oe(O,A,v);return}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,O.__webglTexture,t.TEXTURE0+v)}function j(A,v){const O=i.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){Oe(O,A,v);return}n.bindTexture(t.TEXTURE_3D,O.__webglTexture,t.TEXTURE0+v)}function ne(A,v){const O=i.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&O.__version!==A.version){We(O,A,v);return}n.bindTexture(t.TEXTURE_CUBE_MAP,O.__webglTexture,t.TEXTURE0+v)}const le={[kd]:t.REPEAT,[Gi]:t.CLAMP_TO_EDGE,[Bd]:t.MIRRORED_REPEAT},Ze={[tn]:t.NEAREST,[fT]:t.NEAREST_MIPMAP_NEAREST,[fl]:t.NEAREST_MIPMAP_LINEAR,[hn]:t.LINEAR,[Xc]:t.LINEAR_MIPMAP_NEAREST,[ts]:t.LINEAR_MIPMAP_LINEAR},lt={[pT]:t.NEVER,[xT]:t.ALWAYS,[mT]:t.LESS,[bp]:t.LEQUAL,[gT]:t.EQUAL,[Cp]:t.GEQUAL,[_T]:t.GREATER,[vT]:t.NOTEQUAL};function it(A,v){if(v.type===Mi&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===hn||v.magFilter===Xc||v.magFilter===fl||v.magFilter===ts||v.minFilter===hn||v.minFilter===Xc||v.minFilter===fl||v.minFilter===ts)&&He("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(A,t.TEXTURE_WRAP_S,le[v.wrapS]),t.texParameteri(A,t.TEXTURE_WRAP_T,le[v.wrapT]),(A===t.TEXTURE_3D||A===t.TEXTURE_2D_ARRAY)&&t.texParameteri(A,t.TEXTURE_WRAP_R,le[v.wrapR]),t.texParameteri(A,t.TEXTURE_MAG_FILTER,Ze[v.magFilter]),t.texParameteri(A,t.TEXTURE_MIN_FILTER,Ze[v.minFilter]),v.compareFunction&&(t.texParameteri(A,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(A,t.TEXTURE_COMPARE_FUNC,lt[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===tn||v.minFilter!==fl&&v.minFilter!==ts||v.type===Mi&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");t.texParameterf(A,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function q(A,v){let O=!1;A.__webglInit===void 0&&(A.__webglInit=!0,v.addEventListener("dispose",b));const H=v.source;let X=p.get(H);X===void 0&&(X={},p.set(H,X));const ue=B(v);if(ue!==A.__cacheKey){X[ue]===void 0&&(X[ue]={texture:t.createTexture(),usedTimes:0},a.memory.textures++,O=!0),X[ue].usedTimes++;const de=X[A.__cacheKey];de!==void 0&&(X[A.__cacheKey].usedTimes--,de.usedTimes===0&&R(v)),A.__cacheKey=ue,A.__webglTexture=X[ue].texture}return O}function fe(A,v,O){return Math.floor(Math.floor(A/O)/v)}function se(A,v,O,H){const ue=A.updateRanges;if(ue.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,v.width,v.height,O,H,v.data);else{ue.sort((Ie,ve)=>Ie.start-ve.start);let de=0;for(let Ie=1;Ie<ue.length;Ie++){const ve=ue[de],me=ue[Ie],ke=ve.start+ve.count,Ge=fe(me.start,v.width,4),Je=fe(ve.start,v.width,4);me.start<=ke+1&&Ge===Je&&fe(me.start+me.count-1,v.width,4)===Ge?ve.count=Math.max(ve.count,me.start+me.count-ve.start):(++de,ue[de]=me)}ue.length=de+1;const Y=n.getParameter(t.UNPACK_ROW_LENGTH),J=n.getParameter(t.UNPACK_SKIP_PIXELS),pe=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,v.width);for(let Ie=0,ve=ue.length;Ie<ve;Ie++){const me=ue[Ie],ke=Math.floor(me.start/4),Ge=Math.ceil(me.count/4),Je=ke%v.width,D=Math.floor(ke/v.width),he=Ge,K=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,Je),n.pixelStorei(t.UNPACK_SKIP_ROWS,D),n.texSubImage2D(t.TEXTURE_2D,0,Je,D,he,K,O,H,v.data)}A.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,Y),n.pixelStorei(t.UNPACK_SKIP_PIXELS,J),n.pixelStorei(t.UNPACK_SKIP_ROWS,pe)}}function Oe(A,v,O){let H=t.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(H=t.TEXTURE_2D_ARRAY),v.isData3DTexture&&(H=t.TEXTURE_3D);const X=q(A,v),ue=v.source;n.bindTexture(H,A.__webglTexture,t.TEXTURE0+O);const de=i.get(ue);if(ue.version!==de.__version||X===!0){if(n.activeTexture(t.TEXTURE0+O),(typeof ImageBitmap<"u"&&v.image instanceof ImageBitmap)===!1){const K=ut.getPrimaries(ut.workingColorSpace),ge=v.colorSpace===vr?null:ut.getPrimaries(v.colorSpace),Ee=v.colorSpace===vr||K===ge?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee)}n.pixelStorei(t.UNPACK_ALIGNMENT,v.unpackAlignment);let J=g(v.image,!1,r.maxTextureSize);J=vt(v,J);const pe=s.convert(v.format,v.colorSpace),Ie=s.convert(v.type);let ve=y(v.internalFormat,pe,Ie,v.normalized,v.colorSpace,v.isVideoTexture);it(H,v);let me;const ke=v.mipmaps,Ge=v.isVideoTexture!==!0,Je=de.__version===void 0||X===!0,D=ue.dataReady,he=T(v,J);if(v.isDepthTexture)ve=w(v.format===ns,v.type),Je&&(Ge?n.texStorage2D(t.TEXTURE_2D,1,ve,J.width,J.height):n.texImage2D(t.TEXTURE_2D,0,ve,J.width,J.height,0,pe,Ie,null));else if(v.isDataTexture)if(ke.length>0){Ge&&Je&&n.texStorage2D(t.TEXTURE_2D,he,ve,ke[0].width,ke[0].height);for(let K=0,ge=ke.length;K<ge;K++)me=ke[K],Ge?D&&n.texSubImage2D(t.TEXTURE_2D,K,0,0,me.width,me.height,pe,Ie,me.data):n.texImage2D(t.TEXTURE_2D,K,ve,me.width,me.height,0,pe,Ie,me.data);v.generateMipmaps=!1}else Ge?(Je&&n.texStorage2D(t.TEXTURE_2D,he,ve,J.width,J.height),D&&se(v,J,pe,Ie)):n.texImage2D(t.TEXTURE_2D,0,ve,J.width,J.height,0,pe,Ie,J.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Ge&&Je&&n.texStorage3D(t.TEXTURE_2D_ARRAY,he,ve,ke[0].width,ke[0].height,J.depth);for(let K=0,ge=ke.length;K<ge;K++)if(me=ke[K],v.format!==oi)if(pe!==null)if(Ge){if(D)if(v.layerUpdates.size>0){const Ee=h_(me.width,me.height,v.format,v.type);for(const te of v.layerUpdates){const Ne=me.data.subarray(te*Ee/me.data.BYTES_PER_ELEMENT,(te+1)*Ee/me.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,K,0,0,te,me.width,me.height,1,pe,Ne)}v.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,K,0,0,0,me.width,me.height,J.depth,pe,me.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,K,ve,me.width,me.height,J.depth,0,me.data,0,0);else He("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ge?D&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,K,0,0,0,me.width,me.height,J.depth,pe,Ie,me.data):n.texImage3D(t.TEXTURE_2D_ARRAY,K,ve,me.width,me.height,J.depth,0,pe,Ie,me.data)}else{Ge&&Je&&n.texStorage2D(t.TEXTURE_2D,he,ve,ke[0].width,ke[0].height);for(let K=0,ge=ke.length;K<ge;K++)me=ke[K],v.format!==oi?pe!==null?Ge?D&&n.compressedTexSubImage2D(t.TEXTURE_2D,K,0,0,me.width,me.height,pe,me.data):n.compressedTexImage2D(t.TEXTURE_2D,K,ve,me.width,me.height,0,me.data):He("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ge?D&&n.texSubImage2D(t.TEXTURE_2D,K,0,0,me.width,me.height,pe,Ie,me.data):n.texImage2D(t.TEXTURE_2D,K,ve,me.width,me.height,0,pe,Ie,me.data)}else if(v.isDataArrayTexture)if(Ge){if(Je&&n.texStorage3D(t.TEXTURE_2D_ARRAY,he,ve,J.width,J.height,J.depth),D)if(v.layerUpdates.size>0){const K=h_(J.width,J.height,v.format,v.type);for(const ge of v.layerUpdates){const Ee=J.data.subarray(ge*K/J.data.BYTES_PER_ELEMENT,(ge+1)*K/J.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,ge,J.width,J.height,1,pe,Ie,Ee)}v.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,pe,Ie,J.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,ve,J.width,J.height,J.depth,0,pe,Ie,J.data);else if(v.isData3DTexture)Ge?(Je&&n.texStorage3D(t.TEXTURE_3D,he,ve,J.width,J.height,J.depth),D&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,pe,Ie,J.data)):n.texImage3D(t.TEXTURE_3D,0,ve,J.width,J.height,J.depth,0,pe,Ie,J.data);else if(v.isFramebufferTexture){if(Je)if(Ge)n.texStorage2D(t.TEXTURE_2D,he,ve,J.width,J.height);else{let K=J.width,ge=J.height;for(let Ee=0;Ee<he;Ee++)n.texImage2D(t.TEXTURE_2D,Ee,ve,K,ge,0,pe,Ie,null),K>>=1,ge>>=1}}else if(v.isHTMLTexture){if("texElementImage2D"in t){const K=t.canvas;if(K.hasAttribute("layoutsubtree")||K.setAttribute("layoutsubtree","true"),J.parentNode!==K){K.appendChild(J),h.add(v),K.onpaint=ge=>{const Ee=ge.changedElements;for(const te of h)Ee.includes(te.image)&&(te.needsUpdate=!0)},K.requestPaint();return}if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,J);else{const Ee=t.RGBA,te=t.RGBA,Ne=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,Ee,te,Ne,J)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(ke.length>0){if(Ge&&Je){const K=st(ke[0]);n.texStorage2D(t.TEXTURE_2D,he,ve,K.width,K.height)}for(let K=0,ge=ke.length;K<ge;K++)me=ke[K],Ge?D&&n.texSubImage2D(t.TEXTURE_2D,K,0,0,pe,Ie,me):n.texImage2D(t.TEXTURE_2D,K,ve,pe,Ie,me);v.generateMipmaps=!1}else if(Ge){if(Je){const K=st(J);n.texStorage2D(t.TEXTURE_2D,he,ve,K.width,K.height)}D&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,pe,Ie,J)}else n.texImage2D(t.TEXTURE_2D,0,ve,pe,Ie,J);d(v)&&x(H),de.__version=ue.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function We(A,v,O){if(v.image.length!==6)return;const H=q(A,v),X=v.source;n.bindTexture(t.TEXTURE_CUBE_MAP,A.__webglTexture,t.TEXTURE0+O);const ue=i.get(X);if(X.version!==ue.__version||H===!0){n.activeTexture(t.TEXTURE0+O);const de=ut.getPrimaries(ut.workingColorSpace),Y=v.colorSpace===vr?null:ut.getPrimaries(v.colorSpace),J=v.colorSpace===vr||de===Y?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,J);const pe=v.isCompressedTexture||v.image[0].isCompressedTexture,Ie=v.image[0]&&v.image[0].isDataTexture,ve=[];for(let te=0;te<6;te++)!pe&&!Ie?ve[te]=g(v.image[te],!0,r.maxCubemapSize):ve[te]=Ie?v.image[te].image:v.image[te],ve[te]=vt(v,ve[te]);const me=ve[0],ke=s.convert(v.format,v.colorSpace),Ge=s.convert(v.type),Je=y(v.internalFormat,ke,Ge,v.normalized,v.colorSpace),D=v.isVideoTexture!==!0,he=ue.__version===void 0||H===!0,K=X.dataReady;let ge=T(v,me);it(t.TEXTURE_CUBE_MAP,v);let Ee;if(pe){D&&he&&n.texStorage2D(t.TEXTURE_CUBE_MAP,ge,Je,me.width,me.height);for(let te=0;te<6;te++){Ee=ve[te].mipmaps;for(let Ne=0;Ne<Ee.length;Ne++){const Re=Ee[Ne];v.format!==oi?ke!==null?D?K&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne,0,0,Re.width,Re.height,ke,Re.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne,Je,Re.width,Re.height,0,Re.data):He("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?K&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne,0,0,Re.width,Re.height,ke,Ge,Re.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne,Je,Re.width,Re.height,0,ke,Ge,Re.data)}}}else{if(Ee=v.mipmaps,D&&he){Ee.length>0&&ge++;const te=st(ve[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,ge,Je,te.width,te.height)}for(let te=0;te<6;te++)if(Ie){D?K&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,ve[te].width,ve[te].height,ke,Ge,ve[te].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,Je,ve[te].width,ve[te].height,0,ke,Ge,ve[te].data);for(let Ne=0;Ne<Ee.length;Ne++){const Ot=Ee[Ne].image[te].image;D?K&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne+1,0,0,Ot.width,Ot.height,ke,Ge,Ot.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne+1,Je,Ot.width,Ot.height,0,ke,Ge,Ot.data)}}else{D?K&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,ke,Ge,ve[te]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,Je,ke,Ge,ve[te]);for(let Ne=0;Ne<Ee.length;Ne++){const Re=Ee[Ne];D?K&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne+1,0,0,ke,Ge,Re.image[te]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ne+1,Je,ke,Ge,Re.image[te])}}}d(v)&&x(t.TEXTURE_CUBE_MAP),ue.__version=X.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function Be(A,v,O,H,X,ue){const de=s.convert(O.format,O.colorSpace),Y=s.convert(O.type),J=y(O.internalFormat,de,Y,O.normalized,O.colorSpace),pe=i.get(v),Ie=i.get(O);if(Ie.__renderTarget=v,!pe.__hasExternalTextures){const ve=Math.max(1,v.width>>ue),me=Math.max(1,v.height>>ue);X===t.TEXTURE_3D||X===t.TEXTURE_2D_ARRAY?n.texImage3D(X,ue,J,ve,me,v.depth,0,de,Y,null):n.texImage2D(X,ue,J,ve,me,0,de,Y,null)}n.bindFramebuffer(t.FRAMEBUFFER,A),$e(v)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,H,X,Ie.__webglTexture,0,Xe(v)):(X===t.TEXTURE_2D||X>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&X<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,H,X,Ie.__webglTexture,ue),n.bindFramebuffer(t.FRAMEBUFFER,null)}function mt(A,v,O){if(t.bindRenderbuffer(t.RENDERBUFFER,A),v.depthBuffer){const H=v.depthTexture,X=H&&H.isDepthTexture?H.type:null,ue=w(v.stencilBuffer,X),de=v.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;$e(v)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Xe(v),ue,v.width,v.height):O?t.renderbufferStorageMultisample(t.RENDERBUFFER,Xe(v),ue,v.width,v.height):t.renderbufferStorage(t.RENDERBUFFER,ue,v.width,v.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,de,t.RENDERBUFFER,A)}else{const H=v.textures;for(let X=0;X<H.length;X++){const ue=H[X],de=s.convert(ue.format,ue.colorSpace),Y=s.convert(ue.type),J=y(ue.internalFormat,de,Y,ue.normalized,ue.colorSpace);$e(v)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Xe(v),J,v.width,v.height):O?t.renderbufferStorageMultisample(t.RENDERBUFFER,Xe(v),J,v.width,v.height):t.renderbufferStorage(t.RENDERBUFFER,J,v.width,v.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Ye(A,v,O){const H=v.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,A),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const X=i.get(v.depthTexture);if(X.__renderTarget=v,(!X.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),H){if(X.__webglInit===void 0&&(X.__webglInit=!0,v.depthTexture.addEventListener("dispose",b)),X.__webglTexture===void 0){X.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,X.__webglTexture),it(t.TEXTURE_CUBE_MAP,v.depthTexture);const pe=s.convert(v.depthTexture.format),Ie=s.convert(v.depthTexture.type);let ve;v.depthTexture.format===Qi?ve=t.DEPTH_COMPONENT24:v.depthTexture.format===ns&&(ve=t.DEPTH24_STENCIL8);for(let me=0;me<6;me++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,ve,v.width,v.height,0,pe,Ie,null)}}else U(v.depthTexture,0);const ue=X.__webglTexture,de=Xe(v),Y=H?t.TEXTURE_CUBE_MAP_POSITIVE_X+O:t.TEXTURE_2D,J=v.depthTexture.format===ns?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(v.depthTexture.format===Qi)$e(v)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,J,Y,ue,0,de):t.framebufferTexture2D(t.FRAMEBUFFER,J,Y,ue,0);else if(v.depthTexture.format===ns)$e(v)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,J,Y,ue,0,de):t.framebufferTexture2D(t.FRAMEBUFFER,J,Y,ue,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function ee(A){const v=i.get(A),O=A.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==A.depthTexture){const H=A.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),H){const X=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,H.removeEventListener("dispose",X)};H.addEventListener("dispose",X),v.__depthDisposeCallback=X}v.__boundDepthTexture=H}if(A.depthTexture&&!v.__autoAllocateDepthBuffer)if(O)for(let H=0;H<6;H++)Ye(v.__webglFramebuffer[H],A,H);else{const H=A.texture.mipmaps;H&&H.length>0?Ye(v.__webglFramebuffer[0],A,0):Ye(v.__webglFramebuffer,A,0)}else if(O){v.__webglDepthbuffer=[];for(let H=0;H<6;H++)if(n.bindFramebuffer(t.FRAMEBUFFER,v.__webglFramebuffer[H]),v.__webglDepthbuffer[H]===void 0)v.__webglDepthbuffer[H]=t.createRenderbuffer(),mt(v.__webglDepthbuffer[H],A,!1);else{const X=A.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ue=v.__webglDepthbuffer[H];t.bindRenderbuffer(t.RENDERBUFFER,ue),t.framebufferRenderbuffer(t.FRAMEBUFFER,X,t.RENDERBUFFER,ue)}}else{const H=A.texture.mipmaps;if(H&&H.length>0?n.bindFramebuffer(t.FRAMEBUFFER,v.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=t.createRenderbuffer(),mt(v.__webglDepthbuffer,A,!1);else{const X=A.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ue=v.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,ue),t.framebufferRenderbuffer(t.FRAMEBUFFER,X,t.RENDERBUFFER,ue)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function re(A,v,O){const H=i.get(A);v!==void 0&&Be(H.__webglFramebuffer,A,A.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),O!==void 0&&ee(A)}function ie(A){const v=A.texture,O=i.get(A),H=i.get(v);A.addEventListener("dispose",_);const X=A.textures,ue=A.isWebGLCubeRenderTarget===!0,de=X.length>1;if(de||(H.__webglTexture===void 0&&(H.__webglTexture=t.createTexture()),H.__version=v.version,a.memory.textures++),ue){O.__webglFramebuffer=[];for(let Y=0;Y<6;Y++)if(v.mipmaps&&v.mipmaps.length>0){O.__webglFramebuffer[Y]=[];for(let J=0;J<v.mipmaps.length;J++)O.__webglFramebuffer[Y][J]=t.createFramebuffer()}else O.__webglFramebuffer[Y]=t.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){O.__webglFramebuffer=[];for(let Y=0;Y<v.mipmaps.length;Y++)O.__webglFramebuffer[Y]=t.createFramebuffer()}else O.__webglFramebuffer=t.createFramebuffer();if(de)for(let Y=0,J=X.length;Y<J;Y++){const pe=i.get(X[Y]);pe.__webglTexture===void 0&&(pe.__webglTexture=t.createTexture(),a.memory.textures++)}if(A.samples>0&&$e(A)===!1){O.__webglMultisampledFramebuffer=t.createFramebuffer(),O.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let Y=0;Y<X.length;Y++){const J=X[Y];O.__webglColorRenderbuffer[Y]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,O.__webglColorRenderbuffer[Y]);const pe=s.convert(J.format,J.colorSpace),Ie=s.convert(J.type),ve=y(J.internalFormat,pe,Ie,J.normalized,J.colorSpace,A.isXRRenderTarget===!0),me=Xe(A);t.renderbufferStorageMultisample(t.RENDERBUFFER,me,ve,A.width,A.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Y,t.RENDERBUFFER,O.__webglColorRenderbuffer[Y])}t.bindRenderbuffer(t.RENDERBUFFER,null),A.depthBuffer&&(O.__webglDepthRenderbuffer=t.createRenderbuffer(),mt(O.__webglDepthRenderbuffer,A,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ue){n.bindTexture(t.TEXTURE_CUBE_MAP,H.__webglTexture),it(t.TEXTURE_CUBE_MAP,v);for(let Y=0;Y<6;Y++)if(v.mipmaps&&v.mipmaps.length>0)for(let J=0;J<v.mipmaps.length;J++)Be(O.__webglFramebuffer[Y][J],A,v,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Y,J);else Be(O.__webglFramebuffer[Y],A,v,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0);d(v)&&x(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(de){for(let Y=0,J=X.length;Y<J;Y++){const pe=X[Y],Ie=i.get(pe);let ve=t.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ve=A.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ve,Ie.__webglTexture),it(ve,pe),Be(O.__webglFramebuffer,A,pe,t.COLOR_ATTACHMENT0+Y,ve,0),d(pe)&&x(ve)}n.unbindTexture()}else{let Y=t.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(Y=A.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(Y,H.__webglTexture),it(Y,v),v.mipmaps&&v.mipmaps.length>0)for(let J=0;J<v.mipmaps.length;J++)Be(O.__webglFramebuffer[J],A,v,t.COLOR_ATTACHMENT0,Y,J);else Be(O.__webglFramebuffer,A,v,t.COLOR_ATTACHMENT0,Y,0);d(v)&&x(Y),n.unbindTexture()}A.depthBuffer&&ee(A)}function ye(A){const v=A.textures;for(let O=0,H=v.length;O<H;O++){const X=v[O];if(d(X)){const ue=S(A),de=i.get(X).__webglTexture;n.bindTexture(ue,de),x(ue),n.unbindTexture()}}}const _e=[],ze=[];function De(A){if(A.samples>0){if($e(A)===!1){const v=A.textures,O=A.width,H=A.height;let X=t.COLOR_BUFFER_BIT;const ue=A.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,de=i.get(A),Y=v.length>1;if(Y)for(let pe=0;pe<v.length;pe++)n.bindFramebuffer(t.FRAMEBUFFER,de.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+pe,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,de.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+pe,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,de.__webglMultisampledFramebuffer);const J=A.texture.mipmaps;J&&J.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,de.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,de.__webglFramebuffer);for(let pe=0;pe<v.length;pe++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(X|=t.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(X|=t.STENCIL_BUFFER_BIT)),Y){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,de.__webglColorRenderbuffer[pe]);const Ie=i.get(v[pe]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Ie,0)}t.blitFramebuffer(0,0,O,H,0,0,O,H,X,t.NEAREST),l===!0&&(_e.length=0,ze.length=0,_e.push(t.COLOR_ATTACHMENT0+pe),A.depthBuffer&&A.resolveDepthBuffer===!1&&(_e.push(ue),ze.push(ue),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,ze)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,_e))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),Y)for(let pe=0;pe<v.length;pe++){n.bindFramebuffer(t.FRAMEBUFFER,de.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+pe,t.RENDERBUFFER,de.__webglColorRenderbuffer[pe]);const Ie=i.get(v[pe]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,de.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+pe,t.TEXTURE_2D,Ie,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,de.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const v=A.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[v])}}}function Xe(A){return Math.min(r.maxSamples,A.samples)}function $e(A){const v=i.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function L(A){const v=a.render.frame;f.get(A)!==v&&(f.set(A,v),A.update())}function vt(A,v){const O=A.colorSpace,H=A.format,X=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||O!==ku&&O!==vr&&(ut.getTransfer(O)===gt?(H!==oi||X!==In)&&He("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ct("WebGLTextures: Unsupported texture color space:",O)),v}function st(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(u.width=A.naturalWidth||A.width,u.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(u.width=A.displayWidth,u.height=A.displayHeight):(u.width=A.width,u.height=A.height),u}this.allocateTextureUnit=Z,this.resetTextureUnits=$,this.getTextureUnits=Q,this.setTextureUnits=F,this.setTexture2D=U,this.setTexture2DArray=W,this.setTexture3D=j,this.setTextureCube=ne,this.rebindTextures=re,this.setupRenderTarget=ie,this.updateRenderTargetMipmap=ye,this.updateMultisampleRenderTarget=De,this.setupDepthRenderbuffer=ee,this.setupFrameBufferTexture=Be,this.useMultisampledRTT=$e,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function LR(t,e){function n(i,r=vr){let s;const a=ut.getTransfer(r);if(i===In)return t.UNSIGNED_BYTE;if(i===Mp)return t.UNSIGNED_SHORT_4_4_4_4;if(i===Ep)return t.UNSIGNED_SHORT_5_5_5_1;if(i===Mx)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===Ex)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===yx)return t.BYTE;if(i===Sx)return t.SHORT;if(i===Lo)return t.UNSIGNED_SHORT;if(i===Sp)return t.INT;if(i===Pi)return t.UNSIGNED_INT;if(i===Mi)return t.FLOAT;if(i===Ji)return t.HALF_FLOAT;if(i===Tx)return t.ALPHA;if(i===wx)return t.RGB;if(i===oi)return t.RGBA;if(i===Qi)return t.DEPTH_COMPONENT;if(i===ns)return t.DEPTH_STENCIL;if(i===Ax)return t.RED;if(i===Tp)return t.RED_INTEGER;if(i===ds)return t.RG;if(i===wp)return t.RG_INTEGER;if(i===Ap)return t.RGBA_INTEGER;if(i===nu||i===iu||i===ru||i===su)if(a===gt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===nu)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===iu)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ru)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===su)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===nu)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===iu)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ru)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===su)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===zd||i===Vd||i===Hd||i===Gd)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===zd)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Vd)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Hd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Gd)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Wd||i===Xd||i===Yd||i===Zd||i===$d||i===Ou||i===qd)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Wd||i===Xd)return a===gt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Yd)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Zd)return s.COMPRESSED_R11_EAC;if(i===$d)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Ou)return s.COMPRESSED_RG11_EAC;if(i===qd)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Kd||i===jd||i===Jd||i===Qd||i===eh||i===th||i===nh||i===ih||i===rh||i===sh||i===ah||i===oh||i===lh||i===uh)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Kd)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===jd)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Jd)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Qd)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===eh)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===th)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===nh)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===ih)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===rh)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===sh)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===ah)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===oh)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===lh)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===uh)return a===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===ch||i===fh||i===dh)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===ch)return a===gt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===fh)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===dh)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===hh||i===ph||i===Fu||i===mh)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===hh)return s.COMPRESSED_RED_RGTC1_EXT;if(i===ph)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Fu)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===mh)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===No?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const NR=`
void main() {
